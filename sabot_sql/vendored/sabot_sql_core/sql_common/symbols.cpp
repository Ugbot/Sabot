...
#include "sabot_sql/catalog/catalog_entry/list.hpp"
#include "sabot_sql/common/types/column/column_data_allocator.hpp"
#include "sabot_sql/common/types/column/column_data_collection.hpp"
#include "sabot_sql/common/vector.hpp"
#include "sabot_sql/execution/aggregate_hashtable.hpp"
#include "sabot_sql/execution/column_binding_resolver.hpp"
#include "sabot_sql/execution/join_hashtable.hpp"
...
#include "sabot_sql/parallel/meta_pipeline.hpp"
...
#include "sabot_sql/parser/tableref/list.hpp"
...
#include "sabot_sql/planner/query_node/bound_set_operation_node.hpp"
#include "sabot_sql/storage/data_table.hpp"
#include "sabot_sql/storage/statistics/base_statistics.hpp"
#include "sabot_sql/storage/write_ahead_log.hpp"
#include "sabot_sql/transaction/transaction.hpp"
#include "sabot_sql/common/types/row/row_data_collection.hpp"

using namespace sabot_sql;
...
template class sabot_sql::vector<ExpressionType>;
template class sabot_sql::vector<uint64_t>;
template class sabot_sql::vector<string>;
template class sabot_sql::vector<PhysicalType>;
template class sabot_sql::vector<Value>;
template class sabot_sql::vector<int>;
template class sabot_sql::vector<sabot_sql::vector<Expression *>>;
template class sabot_sql::vector<LogicalType>;

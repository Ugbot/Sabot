...
//
// Note: The generated code will only work properly if the enum is a top level item in the sabot_sql namespace
// If the enum is nested in a class, or in another namespace, the generated code will not compile.
// You should move the enum to the sabot_sql namespace, manually write a specialization or add it to the blacklist
//-------------------------------------------------------------------------
...
#include "sabot_sql/common/enums/checkpoint_abort.hpp"
...
#include "sabot_sql/common/enums/quantile_enum.hpp"
...
#include "sabot_sql/common/enums/storage_block_prefetch.hpp"
...
#include "sabot_sql/execution/index/art/art_scanner.hpp"
...
#include "sabot_sql/storage/temporary_file_manager.hpp"
...
const StringUtil::EnumStringLiteral *GetDataFileTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(DataFileType::SABOT_SQL_FILE), "SABOT_SQL_FILE" },

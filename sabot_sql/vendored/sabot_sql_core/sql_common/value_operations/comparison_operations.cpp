...
template <>
inline bool ValuePositionComparator::Definite<sabot_sql::Equals>(const Value &lhs, const Value &rhs) {
	return false;
}

template <>
inline bool ValuePositionComparator::Final<sabot_sql::Equals>(const Value &lhs, const Value &rhs) {
	return ValueOperations::NotDistinctFrom(lhs, rhs);
}

// NotEquals must check everything that matched
template <>
inline bool ValuePositionComparator::Possible<sabot_sql::NotEquals>(const Value &lhs, const Value &rhs) {
	return true;
}

template <>
inline bool ValuePositionComparator::Final<sabot_sql::NotEquals>(const Value &lhs, const Value &rhs) {
	return ValueOperations::NotDistinctFrom(lhs, rhs);
}

template <>
bool ValuePositionComparator::Final<sabot_sql::GreaterThan>(const Value &lhs, const Value &rhs) {
...
bool ValueOperations::Equals(const Value &left, const Value &right) {
	...
	return TemplatedBooleanOperation<sabot_sql::Equals>(left, right);
}
...
bool ValueOperations::GreaterThan(const Value &left, const Value &right) {
	...
	return TemplatedBooleanOperation<sabot_sql::GreaterThan>(left, right);
}

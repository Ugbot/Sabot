...
#include "sabot_sql/common/exception/list.hpp"
#include "sabot_sql/parser/tableref.hpp"
#include "sabot_sql/planner/expression.hpp"

#ifdef SABOT_SQL_CRASH_ON_ASSERT
#include "sabot_sql/common/printer.hpp"
#include <stdio.h>
#include <stdlib.h>
#endif
#include "sabot_sql/common/stacktrace.hpp"
...
#ifndef SABOT_SQL_DEBUG_STACKTRACE
...
string OutOfMemoryException::ExtendOutOfMemoryError(const string &msg) {
	string link = "https://sabot_sql.org/docs/stable/guides/performance/how_to_tune_workloads";

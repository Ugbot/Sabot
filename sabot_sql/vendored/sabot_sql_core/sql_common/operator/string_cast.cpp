#include "sabot_sql/common/types/cast_helpers.hpp"
...
template <>
sabot_sql::string_t StringCast::Operation(uint8_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint8_t>(input, vector);
}
template <>
sabot_sql::string_t StringCast::Operation(uint16_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint16_t>(input, vector);
}
template <>
sabot_sql::string_t StringCast::Operation(uint32_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint32_t>(input, vector);
}
template <>
sabot_sql::string_t StringCast::Operation(uint64_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint64_t>(input, vector);
}
template <>
sabot_sql::string_t StringCast::Operation(hugeint_t input, Vector &vector) {
	return NumericHelper::FormatSigned<hugeint_t>(input, vector);
}

template <>
string_t StringCast::Operation(float input, Vector &vector) {
	std::string s = sabot_sql_fmt::format("{}", input);
...
template <>
sabot_sql::string_t StringCast::Operation(uhugeint_t input, Vector &vector) {
	return UhugeintToStringCast::Format(input, vector);
}

template <>
sabot_sql::string_t StringCast::Operation(date_t input, Vector &vector) {
...
sabot_sql::string_t StringAsTime(dtime_t input, Vector &vector) {
	int32_t picos = 0;
	if (HAS_NANOS) {
...
template <>
sabot_sql::string_t StringCast::Operation(dtime_t input, Vector &vector) {
	return StringAsTime<false>(input, vector);
}

template <>
sabot_sql::string_t StringCast::Operation(dtime_ns_t input, Vector &vector) {
	return StringAsTime<true>(input, vector);
}

template <bool HAS_NANOS>
sabot_sql::string_t StringFromTimestamp(timestamp_t input, Vector &vector) {
...
template <>
sabot_sql::string_t StringCast::Operation(timestamp_t input, Vector &vector) {
	return StringFromTimestamp<false>(input, vector);
}

template <>
sabot_sql::string_t StringCast::Operation(timestamp_ns_t input, Vector &vector) {
	return StringFromTimestamp<true>(input, vector);
}

template <>
sabot_sql::string_t StringCast::Operation(sabot_sql::string_t input, Vector &result) {

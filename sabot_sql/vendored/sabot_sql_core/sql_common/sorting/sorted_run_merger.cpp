#include "sabot_sql/common/sorting/sorted_run_merger.hpp"

#include "sabot_sql/common/sorting/sort.hpp"
#include "sabot_sql/common/sorting/sorted_run.hpp"
#include "sabot_sql/common/sorting/sort_key.hpp"
#include "sabot_sql/common/types/row/block_iterator.hpp"
#include "sabot_sql/common/types/row/tuple_data_collection.hpp"
...
void SortedRunMergerLocalState::TemplatedMergePartition(SortedRunMergerGlobalState &gstate,
	...
	static const auto fallback = [](SORT_KEY *begin, SORT_KEY *end) {
		sabot_sql_pdqsort::pdqsort_branchless(begin, end);
	};
	sabot_sql_vergesort::vergesort(merged_partition_keys, merged_partition_keys + merged_partition_count,

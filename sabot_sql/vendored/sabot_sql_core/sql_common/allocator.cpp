...
#ifdef SABOT_SQL_DEBUG_ALLOCATION
...
#ifndef USE_JEMALLOC
#if defined(SABOT_SQL_EXTENSION_JEMALLOC_LINKED) && SABOT_SQL_EXTENSION_JEMALLOC_LINKED && !defined(WIN32) &&                \
...
AllocatorDebugInfo::~AllocatorDebugInfo() {
	...
	//! If this assertion triggers, enable SABOT_SQL_DEBUG_ALLOCATION for more information about the allocations

...
unique_ptr<ConstantExpression> Transformer::TransformValue(sabot_sql_libpgquery::PGValue val) {
	switch (val.type) {
	...
	case sabot_sql_libpgquery::T_PGBitString: // FIXME: this should actually convert to BLOB
...
unique_ptr<ParsedExpression> Transformer::TransformConstant(sabot_sql_libpgquery::PGAConst &c) {

...
static PreparedParam GetParameterIdentifier(sabot_sql_libpgquery::PGParamRef &node) {
	PreparedParam param;
	if (node.name) {
...
unique_ptr<ParsedExpression> Transformer::TransformParamRef(sabot_sql_libpgquery::PGParamRef &node) {

...
unique_ptr<PrepareStatement> Transformer::TransformPrepare(sabot_sql_libpgquery::PGPrepareStmt &stmt) {
...
unique_ptr<ExecuteStatement> Transformer::TransformExecute(sabot_sql_libpgquery::PGExecuteStmt &stmt) {
...
unique_ptr<DropStatement> Transformer::TransformDeallocate(sabot_sql_libpgquery::PGDeallocateStmt &stmt) {
	if (!stmt.name) {

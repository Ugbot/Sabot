...
unique_ptr<QueryNode> Transformer::TransformShow(sabot_sql_libpgquery::PGVariableShowStmt &stmt) {
...
unique_ptr<SelectStatement> Transformer::TransformShowStmt(sabot_sql_libpgquery::PGVariableShowStmt &stmt) {

...
unique_ptr<AlterStatement> Transformer::TransformRename(sabot_sql_libpgquery::PGRenameStmt &stmt) {
	if (!stmt.relation) {
	...
	case sabot_sql_libpgquery::PG_OBJECT_COLUMN: {
		// change column name
	...
	case sabot_sql_libpgquery::PG_OBJECT_DATABASE:
	default:

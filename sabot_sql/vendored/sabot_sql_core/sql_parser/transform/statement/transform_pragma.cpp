...
unique_ptr<SQLStatement> Transformer::TransformPragma(sabot_sql_libpgquery::PGPragmaStmt &stmt) {
	...
	switch (stmt.kind) {
	case sabot_sql_libpgquery::PG_PRAGMA_TYPE_NOTHING: {
		...
		break;
	case sabot_sql_libpgquery::PG_PRAGMA_TYPE_ASSIGNMENT:
	...
	case sabot_sql_libpgquery::PG_PRAGMA_TYPE_CALL:
		break;
	default:

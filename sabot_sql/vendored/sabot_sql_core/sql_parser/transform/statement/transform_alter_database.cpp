...
unique_ptr<AlterStatement> Transformer::TransformAlterDatabase(sabot_sql_libpgquery::PGAlterDatabaseStmt &stmt) {
	...
	case sabot_sql_libpgquery::PG_ALTER_DATABASE_RENAME: {
		if (!stmt.new_name) {

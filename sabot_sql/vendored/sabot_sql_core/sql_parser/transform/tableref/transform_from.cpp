...
unique_ptr<TableRef> Transformer::TransformFrom(optional_ptr<sabot_sql_libpgquery::PGList> root) {
	if (!root) {
	...
	auto n = PGPointerCast<sabot_sql_libpgquery::PGNode>(root->head->data.ptr_value);

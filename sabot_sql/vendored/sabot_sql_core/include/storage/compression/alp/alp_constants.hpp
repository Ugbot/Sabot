...
//                         SabotSQL
//
// sabot_sql/storage/compression/alp/alp_constants.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	...
	static constexpr uint32_t RG_SAMPLES_SABOT_SQL_JUMP = (DEFAULT_ROW_GROUP_SIZE / RG_SAMPLES) / STANDARD_VECTOR_SIZE;

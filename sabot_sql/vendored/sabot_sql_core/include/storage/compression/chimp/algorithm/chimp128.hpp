...
//                         SabotSQL
//
// sabot_sql/storage/compression/chimp/algorithm/chimp128.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql.h"
#include "sabot_sql/storage/compression/chimp/algorithm/chimp_utils.hpp"
#include "sabot_sql/storage/compression/chimp/algorithm/leading_zero_buffer.hpp"
#include "sabot_sql/storage/compression/chimp/algorithm/flag_buffer.hpp"
#include "sabot_sql/storage/compression/chimp/algorithm/ring_buffer.hpp"
#include "sabot_sql/common/fast_mem.hpp"
#include "sabot_sql/common/likely.hpp"
#include "sabot_sql/storage/compression/chimp/algorithm/packed_data.hpp"
#include "sabot_sql/common/limits.hpp"
#include "sabot_sql/common/bit_utils.hpp"

#include "sabot_sql/storage/compression/chimp/algorithm/bit_reader.hpp"
#include "sabot_sql/storage/compression/chimp/algorithm/output_bit_stream.hpp"
...
public:
	...
	static inline CHIMP_TYPE Load(ChimpConstants::Flags flag, uint8_t leading_zeros[], uint32_t &leading_zero_index,
		...
		if (SABOT_SQL_UNLIKELY(state.first)) {

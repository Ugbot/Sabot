...
//                         SabotSQL
//
// sabot_sql/storage/metadata/metadata_manager.hpp
//
//
//===----------------------------------------------------------------------===//
...
struct MetadataBlock {
	...
	SABOT_SQL_API MetadataBlock(MetadataBlock &&other) noexcept;
	SABOT_SQL_API MetadataBlock &operator=(MetadataBlock &&) noexcept;

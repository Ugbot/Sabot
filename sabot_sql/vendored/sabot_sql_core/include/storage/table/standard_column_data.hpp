...
//                         SabotSQL
//
// sabot_sql/storage/table/standard_column_data.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/storage/table/validity_column_data.hpp"
...
public:
	...
	void GetColumnSegmentInfo(const QueryContext &context, sabot_sql::idx_t row_group_index,
	                          vector<sabot_sql::idx_t> col_path, vector<sabot_sql::ColumnSegmentInfo> &result) override;

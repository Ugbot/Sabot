...
//                         SabotSQL
//
// sabot_sql/storage/storage_info.hpp
//
//
//===----------------------------------------------------------------------===//
...
#ifndef SABOT_SQL_BLOCK_HEADER_STORAGE_SIZE
#define SABOT_SQL_BLOCK_HEADER_STORAGE_SIZE     DEFAULT_BLOCK_HEADER_STORAGE_SIZE
...
struct Storage {
	...
	//! The maximum block allocation size. This is the maximum size currently supported by sabot_sql.
...
string GetSabotSQLVersions(const idx_t version_number);

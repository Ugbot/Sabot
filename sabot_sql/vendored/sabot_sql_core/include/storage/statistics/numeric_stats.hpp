...
//                         SabotSQL
//
// sabot_sql/storage/statistics/numeric_stats.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/storage/statistics/numeric_stats_union.hpp"
...
struct NumericStats {
	...
	SABOT_SQL_API static bool IsConstant(const BaseStatistics &stats);
	//! Returns true if the stats has both a min and max value defined
	SABOT_SQL_API static bool HasMinMax(const BaseStatistics &stats);
	//! Returns true if the stats has a min value defined
	SABOT_SQL_API static bool HasMin(const BaseStatistics &stats);
	//! Returns true if the stats has a max value defined
	SABOT_SQL_API static bool HasMax(const BaseStatistics &stats);
	//! Returns the min value - throws an exception if there is no min value
	SABOT_SQL_API static Value Min(const BaseStatistics &stats);
	//! Returns the max value - throws an exception if there is no max value
	SABOT_SQL_API static Value Max(const BaseStatistics &stats);
	//! Sets the min value of the statistics
	SABOT_SQL_API static void SetMin(BaseStatistics &stats, const Value &val);
	//! Sets the max value of the statistics
	SABOT_SQL_API static void SetMax(BaseStatistics &stats, const Value &val);
	...
	SABOT_SQL_API static void Merge(BaseStatistics &stats, const BaseStatistics &other_p);

	SABOT_SQL_API static void Serialize(const BaseStatistics &stats, Serializer &serializer);
	SABOT_SQL_API static void Deserialize(Deserializer &deserializer, BaseStatistics &stats);

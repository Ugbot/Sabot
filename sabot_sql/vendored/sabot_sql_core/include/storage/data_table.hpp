...
//                         SabotSQL
//
// sabot_sql/storage/data_table.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/storage/statistics/column_statistics.hpp"
#include "sabot_sql/storage/table/column_segment.hpp"
#include "sabot_sql/storage/table/data_table_info.hpp"
#include "sabot_sql/storage/table/persistent_table_data.hpp"
#include "sabot_sql/storage/table/row_group.hpp"
#include "sabot_sql/storage/table/row_group_collection.hpp"

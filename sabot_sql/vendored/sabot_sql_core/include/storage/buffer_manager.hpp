...
//                         SabotSQL
//
// sabot_sql/storage/buffer_manager.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/storage/block_manager.hpp"
#include "sabot_sql/storage/buffer/buffer_handle.hpp"
#include "sabot_sql/storage/buffer/temporary_file_information.hpp"
...
public:
	SABOT_SQL_API static BufferManager &GetBufferManager(DatabaseInstance &db);
	SABOT_SQL_API static const BufferManager &GetBufferManager(const DatabaseInstance &db);
	SABOT_SQL_API static BufferManager &GetBufferManager(ClientContext &context);
	SABOT_SQL_API static const BufferManager &GetBufferManager(const ClientContext &context);
	SABOT_SQL_API static BufferManager &GetBufferManager(AttachedDatabase &db);
	SABOT_SQL_API static idx_t GetAllocSize(const idx_t alloc_size);
...
public:
	...
	virtual SABOT_SQL_API Allocator &GetBufferAllocator();
	//! Reserve memory.
	virtual SABOT_SQL_API void ReserveMemory(idx_t size);
	//! Free reserved memory.
	virtual SABOT_SQL_API void FreeReservedMemory(idx_t size);

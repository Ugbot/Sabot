...
//                         SabotSQL
//
// sabot_sql/common/enums/expression_type.hpp
//
//
//===----------------------------------------------------------------------===//
...
SABOT_SQL_API string ExpressionTypeToString(ExpressionType type);
...
SABOT_SQL_API string ExpressionClassToString(ExpressionClass type);

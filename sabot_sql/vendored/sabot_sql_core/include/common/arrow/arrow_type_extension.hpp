...
//                         SabotSQL
//
// sabot_sql/common/arrow/arrow_type_extension.hpp
//
//
//===----------------------------------------------------------------------===//
...
private:
	...
	//! The vendor_name is the system that produced the type (e.g., SabotSQL)
	string vendor_name {};
...
typedef void (*populate_arrow_schema_t)(SabotSQLArrowSchemaHolder &root_holder, ArrowSchema &child,
...
public:
	...
	ArrowTypeExtension(string vendor_name, string type_name, populate_arrow_schema_t populate_arrow_schema,
	                   get_type_t get_type, shared_ptr<ArrowTypeExtensionData> type, cast_arrow_duck_t arrow_to_sabot_sql,
	...
	static void PopulateArrowSchema(SabotSQLArrowSchemaHolder &root_holder, ArrowSchema &child,

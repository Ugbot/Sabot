...
//                         SabotSQL
//
// sabot_sql/common/types/hugeint.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	...
	template <class T>
	SABOT_SQL_API static bool TryCast(hugeint_t input, T &result);
...
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, int8_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, int16_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, int32_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, int64_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, uint8_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, uint16_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, uint32_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, uint64_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, hugeint_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, uhugeint_t &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, float &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, double &result);
template <>
SABOT_SQL_API bool Hugeint::TryCast(hugeint_t input, long double &result);

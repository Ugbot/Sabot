...
//                         SabotSQL
//
// sabot_sql/common/exception.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/common/exception_format_value.hpp"
...
public:
	SABOT_SQL_API Exception(ExceptionType exception_type, const string &message);
	SABOT_SQL_API Exception(ExceptionType exception_type, const string &message,
	                     const unordered_map<string, string> &extra_info);

public:
	SABOT_SQL_API static string ExceptionTypeToString(ExceptionType type);
	SABOT_SQL_API static ExceptionType StringToExceptionType(const string &type);
	...
	SABOT_SQL_API static unordered_map<string, string> InitializeExtraInfo(const Expression &expr);
	SABOT_SQL_API static unordered_map<string, string> InitializeExtraInfo(const ParsedExpression &expr);
	SABOT_SQL_API static unordered_map<string, string> InitializeExtraInfo(const QueryErrorContext &error_context);
	SABOT_SQL_API static unordered_map<string, string> InitializeExtraInfo(const TableRef &ref);
	SABOT_SQL_API static unordered_map<string, string> InitializeExtraInfo(optional_idx error_location);
	SABOT_SQL_API static unordered_map<string, string> InitializeExtraInfo(const string &subtype,
	                                                                    optional_idx error_location);

	//! Whether this exception type can occur during execution of a query
	SABOT_SQL_API static bool IsExecutionError(ExceptionType type);
	SABOT_SQL_API static string ToJSON(ExceptionType type, const string &message);
	SABOT_SQL_API static string ToJSON(ExceptionType type, const string &message,
	                                const unordered_map<string, string> &extra_info);

	SABOT_SQL_API static bool InvalidatesTransaction(ExceptionType exception_type);
	SABOT_SQL_API static bool InvalidatesDatabase(ExceptionType exception_type);

	SABOT_SQL_API static string ConstructMessageRecursive(const string &msg, std::vector<ExceptionFormatValue> &values);
	...
	SABOT_SQL_API static bool UncaughtException();

	SABOT_SQL_API static string GetStackTrace(idx_t max_depth = 120);
	static string FormatStackTrace(const string &message = "") {
		return (message + "\n" + GetStackTrace());
	}

	SABOT_SQL_API static void SetQueryLocation(optional_idx error_location, unordered_map<string, string> &extra_info);
};
...
public:
	SABOT_SQL_API explicit ConnectionException(const string &msg);
...
public:
	SABOT_SQL_API explicit PermissionException(const string &msg);
...
public:
	SABOT_SQL_API explicit OutOfRangeException(const string &msg);

	template <typename... ARGS>
	explicit OutOfRangeException(const string &msg, ARGS... params)
	    : OutOfRangeException(ConstructMessage(msg, params...)) {
	}
	SABOT_SQL_API OutOfRangeException(const int64_t value, const PhysicalType orig_type, const PhysicalType new_type);
	SABOT_SQL_API OutOfRangeException(const hugeint_t value, const PhysicalType orig_type, const PhysicalType new_type);
	SABOT_SQL_API OutOfRangeException(const double value, const PhysicalType orig_type, const PhysicalType new_type);
	SABOT_SQL_API OutOfRangeException(const PhysicalType var_type, const idx_t length);
};

class OutOfMemoryException : public Exception {
public:
	SABOT_SQL_API explicit OutOfMemoryException(const string &msg);
...
public:
	SABOT_SQL_API explicit SyntaxException(const string &msg);
...
public:
	SABOT_SQL_API explicit ConstraintException(const string &msg);
...
public:
	SABOT_SQL_API explicit DependencyException(const string &msg);
...
public:
	SABOT_SQL_API explicit IOException(const string &msg);
	SABOT_SQL_API explicit IOException(const string &msg, const unordered_map<string, string> &extra_info);
...
public:
	SABOT_SQL_API explicit MissingExtensionException(const string &msg);
...
public:
	SABOT_SQL_API explicit NotImplementedException(const string &msg);
...
public:
	SABOT_SQL_API explicit AutoloadException(const string &extension_name, const string &message);
};

class SerializationException : public Exception {
public:
	SABOT_SQL_API explicit SerializationException(const string &msg);
...
public:
	SABOT_SQL_API explicit SequenceException(const string &msg);
...
public:
	SABOT_SQL_API InterruptException();
};
...
protected:
	SABOT_SQL_API explicit FatalException(ExceptionType type, const string &msg);
	template <typename... ARGS>
...
public:
	SABOT_SQL_API explicit InternalException(const string &msg);
...
public:
	SABOT_SQL_API explicit InvalidInputException(const string &msg);
	SABOT_SQL_API explicit InvalidInputException(const string &msg, const unordered_map<string, string> &extra_info);
...
public:
	SABOT_SQL_API explicit ExecutorException(const string &msg);
...
public:
	SABOT_SQL_API explicit InvalidConfigurationException(const string &msg);
	SABOT_SQL_API explicit InvalidConfigurationException(const string &msg,
	                                                  const unordered_map<string, string> &extra_info);
...
public:
	SABOT_SQL_API InvalidTypeException(PhysicalType type, const string &msg);
	SABOT_SQL_API InvalidTypeException(const LogicalType &type, const string &msg);
	SABOT_SQL_API explicit InvalidTypeException(const string &msg);
};

class TypeMismatchException : public Exception {
public:
	SABOT_SQL_API TypeMismatchException(const PhysicalType type_1, const PhysicalType type_2, const string &msg);
	SABOT_SQL_API TypeMismatchException(const LogicalType &type_1, const LogicalType &type_2, const string &msg);
	SABOT_SQL_API TypeMismatchException(optional_idx error_location, const LogicalType &type_1, const LogicalType &type_2,
	                                 const string &msg);
	SABOT_SQL_API explicit TypeMismatchException(const string &msg);
};

class ParameterNotAllowedException : public Exception {
public:
	SABOT_SQL_API explicit ParameterNotAllowedException(const string &msg);
...
public:
	SABOT_SQL_API explicit ParameterNotResolvedException();
};

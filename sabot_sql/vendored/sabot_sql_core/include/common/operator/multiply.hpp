...
//                         SabotSQL
//
// sabot_sql/common/operator/multiply.hpp
//
//
//===----------------------------------------------------------------------===//
...
template <>
SABOT_SQL_API bool TryMultiplyOperator::Operation(int64_t left, int64_t right, int64_t &result);
template <>
SABOT_SQL_API bool TryMultiplyOperator::Operation(hugeint_t left, hugeint_t right, hugeint_t &result);
template <>
SABOT_SQL_API bool TryMultiplyOperator::Operation(uhugeint_t left, uhugeint_t right, uhugeint_t &result);

...
//                         SabotSQL
//
// sabot_sql/common/operator/comparison_operators.hpp
//
//
//===----------------------------------------------------------------------===//
...
template <>
SABOT_SQL_API bool Equals::Operation(const float &left, const float &right);
template <>
SABOT_SQL_API bool Equals::Operation(const double &left, const double &right);

template <>
SABOT_SQL_API bool GreaterThan::Operation(const float &left, const float &right);
template <>
SABOT_SQL_API bool GreaterThan::Operation(const double &left, const double &right);

template <>
SABOT_SQL_API bool GreaterThanEquals::Operation(const float &left, const float &right);
template <>
SABOT_SQL_API bool GreaterThanEquals::Operation(const double &left, const double &right);

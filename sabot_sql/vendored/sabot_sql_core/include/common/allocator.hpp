...
//                         SabotSQL
//
// sabot_sql/common/allocator.hpp
//
//
//===----------------------------------------------------------------------===//
...
class AllocatedData {
public:
	SABOT_SQL_API AllocatedData();
	SABOT_SQL_API AllocatedData(Allocator &allocator, data_ptr_t pointer, idx_t allocated_size);
	SABOT_SQL_API ~AllocatedData();
	// disable copy constructors
	AllocatedData(const AllocatedData &other) = delete;
	AllocatedData &operator=(const AllocatedData &) = delete;
	//! enable move constructors
	SABOT_SQL_API AllocatedData(AllocatedData &&other) noexcept;
	SABOT_SQL_API AllocatedData &operator=(AllocatedData &&) noexcept;
...
public:
	SABOT_SQL_API Allocator();
	SABOT_SQL_API Allocator(allocate_function_ptr_t allocate_function_p, free_function_ptr_t free_function_p,
	...
	SABOT_SQL_API data_ptr_t AllocateData(idx_t size);
	SABOT_SQL_API void FreeData(data_ptr_t pointer, idx_t size);
	SABOT_SQL_API data_ptr_t ReallocateData(data_ptr_t pointer, idx_t old_size, idx_t new_size);
	...
	SABOT_SQL_API static Allocator &DefaultAllocator();
	SABOT_SQL_API static shared_ptr<Allocator> &DefaultAllocatorReference();
...
struct BufferAllocator {
	SABOT_SQL_API static Allocator &Get(ClientContext &context);
	SABOT_SQL_API static Allocator &Get(DatabaseInstance &db);
	SABOT_SQL_API static Allocator &Get(AttachedDatabase &db);
};

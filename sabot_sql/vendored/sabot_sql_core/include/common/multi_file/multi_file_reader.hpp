...
//                         SabotSQL
//
// sabot_sql/common/multi_file/multi_file_reader.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/common/multi_file/multi_file_list.hpp"
...
#include "sabot_sql/common/multi_file/multi_file_states.hpp"
...
public:
	...
	SABOT_SQL_API static unique_ptr<MultiFileReader> Create(const TableFunction &table_function);
	//! Create a default MultiFileReader, function_name is used for errors
	SABOT_SQL_API static unique_ptr<MultiFileReader> CreateDefault(const string &function_name = "");
	...
	SABOT_SQL_API shared_ptr<MultiFileList>
	CreateFileList(ClientContext &context, const Value &input,
	               const FileGlobInput &glob_input = FileGlobOptions::DISALLOW_EMPTY);

	//! Parse the named parameters of a multi-file reader
	SABOT_SQL_API virtual bool ParseOption(const string &key, const Value &val, MultiFileOptions &options,
	                                    ClientContext &context);
	//! Perform filter pushdown into the MultiFileList. Returns a new MultiFileList if filters were pushed down
	SABOT_SQL_API virtual unique_ptr<MultiFileList> ComplexFilterPushdown(ClientContext &context, MultiFileList &files,
	                                                                   const MultiFileOptions &options,
	                                                                   MultiFilePushdownInfo &info,
	                                                                   vector<unique_ptr<Expression>> &filters);
	SABOT_SQL_API virtual unique_ptr<MultiFileList>
	...
	//! directly.
	SABOT_SQL_API virtual bool Bind(MultiFileOptions &options, MultiFileList &files, vector<LogicalType> &return_types,
	                             vector<string> &names, MultiFileReaderBindData &bind_data);
	//! Bind the options of the multi-file reader, potentially emitting any extra columns that are required
	SABOT_SQL_API virtual void BindOptions(MultiFileOptions &options, MultiFileList &files,
	                                    vector<LogicalType> &return_types, vector<string> &names,
	                                    MultiFileReaderBindData &bind_data);

	//! Initialize global state used by the MultiFileReader
	SABOT_SQL_API virtual unique_ptr<MultiFileReaderGlobalState>
	...
	SABOT_SQL_API virtual void FinalizeBind(MultiFileReaderData &reader_data, const MultiFileOptions &file_options,
	...
	SABOT_SQL_API virtual ReaderInitializeType
	...
	SABOT_SQL_API virtual void FinalizeChunk(ClientContext &context, const MultiFileBindData &bind_data,
	...
	SABOT_SQL_API virtual void GetPartitionData(ClientContext &context, const MultiFileReaderBindData &bind_data,
	                                         const MultiFileReaderData &reader_data,
	                                         optional_ptr<MultiFileReaderGlobalState> global_state,
	                                         const OperatorPartitionInfo &partition_info,
	                                         OperatorPartitionData &partition_data);

	SABOT_SQL_API static void GetVirtualColumns(ClientContext &context, MultiFileReaderBindData &bind_data,
	...
	SABOT_SQL_API virtual ReaderInitializeType InitializeReader(MultiFileReaderData &reader_data,
	...
	SABOT_SQL_API virtual shared_ptr<BaseFileReader> CreateReader(ClientContext &context, GlobalTableFunctionState &gstate,
	                                                           BaseUnionData &union_data,
	                                                           const MultiFileBindData &bind_data);
	SABOT_SQL_API virtual shared_ptr<BaseFileReader> CreateReader(ClientContext &context, GlobalTableFunctionState &gstate,
	                                                           const OpenFileInfo &file, idx_t file_idx,
	                                                           const MultiFileBindData &bind_data);
	SABOT_SQL_API virtual shared_ptr<BaseFileReader> CreateReader(ClientContext &context, const OpenFileInfo &file,
	                                                           BaseFileReaderOptions &options,
	                                                           const MultiFileOptions &file_options,
	                                                           MultiFileReaderInterface &interface);

	//! Get partition info
	SABOT_SQL_API virtual TablePartitionInfo GetPartitionInfo(ClientContext &context,
	...
	SABOT_SQL_API virtual unique_ptr<Expression> GetConstantVirtualColumn(MultiFileReaderData &reader_data,
	                                                                   idx_t column_id, const LogicalType &type);

	//! Gets an expression to evaluate the given virtual column
	SABOT_SQL_API virtual unique_ptr<Expression>
	...
	SABOT_SQL_API virtual unique_ptr<MultiFileReader> Copy() const;

	SABOT_SQL_API virtual FileGlobInput GetGlobInput(MultiFileReaderInterface &interface);

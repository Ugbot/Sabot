...
//                         SabotSQL
//
// sabot_sql/common/multi_file/multi_file_states.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/common/multi_file/multi_file_data.hpp"
...
struct MultiFileReaderBindData {
	...
	SABOT_SQL_API static MultiFileReaderBindData Deserialize(Deserializer &deserializer);
};

...
//                         SabotSQL
//
// sabot_sql/common/multi_file/multi_file_list.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/common/extra_operator_info.hpp"
...
public:
	SABOT_SQL_API explicit MultiFileListIterationHelper(MultiFileList &collection);
...
private:
	...
	class MultiFileListIterator {
	public:
		SABOT_SQL_API explicit MultiFileListIterator(MultiFileList *file_list);
	...
	public:
		...
		SABOT_SQL_API MultiFileListIterator &operator++();
		SABOT_SQL_API bool operator!=(const MultiFileListIterator &other) const;
		SABOT_SQL_API const OpenFileInfo &operator*() const;
	};

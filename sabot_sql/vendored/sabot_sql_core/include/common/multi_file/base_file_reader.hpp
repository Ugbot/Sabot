...
//                         SabotSQL
//
// sabot_sql/common/multi_file/base_file_reader.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	...
	SABOT_SQL_API virtual ~BaseFileReader() = default;
...
public:
	SABOT_SQL_API virtual shared_ptr<BaseUnionData> GetUnionData(idx_t file_idx);
	//! Get statistics for a specific column
	SABOT_SQL_API virtual unique_ptr<BaseStatistics> GetStatistics(ClientContext &context, const string &name);
	//! Prepare reader for scanning
	SABOT_SQL_API virtual void PrepareReader(ClientContext &context, GlobalTableFunctionState &);
	...
	SABOT_SQL_API virtual void FinishFile(ClientContext &context, GlobalTableFunctionState &gstate);
	//! Get progress within a given file
	SABOT_SQL_API virtual double GetProgressInFile(ClientContext &context);
...
public:
	SABOT_SQL_API virtual ~BaseFileReaderOptions() = default;
...
public:
	...
	SABOT_SQL_API virtual ~BaseUnionData() = default;

...
//                         SabotSQL
//
// sabot_sql/common/constants.hpp
//
//
//===----------------------------------------------------------------------===//
...
SABOT_SQL_API bool IsInvalidSchema(const string &str);
SABOT_SQL_API bool IsInvalidCatalog(const string &str);

//! Special value used to signify the ROW ID of a table
SABOT_SQL_API extern const column_t COLUMN_IDENTIFIER_ROW_ID;
//! Special value used to signify an empty column (used for e.g. COUNT(*))
SABOT_SQL_API extern const column_t COLUMN_IDENTIFIER_EMPTY;
SABOT_SQL_API extern const column_t VIRTUAL_COLUMN_START;
SABOT_SQL_API bool IsRowIdColumnId(column_t column_id);
SABOT_SQL_API bool IsVirtualColumn(column_t column_id);
...
SABOT_SQL_API bool IsPowerOfTwo(uint64_t v);
SABOT_SQL_API uint64_t NextPowerOfTwo(uint64_t v);
SABOT_SQL_API uint64_t PreviousPowerOfTwo(uint64_t v);

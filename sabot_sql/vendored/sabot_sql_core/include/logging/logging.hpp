...
struct LogConfig {
	...
	SABOT_SQL_API static LogConfig Create(bool enabled, LogLevel level);
	SABOT_SQL_API static LogConfig CreateFromEnabled(bool enabled, LogLevel level,
	                                              unordered_set<string> &enabled_log_types);
	SABOT_SQL_API static LogConfig CreateFromDisabled(bool enabled, LogLevel level,
	                                               unordered_set<string> &disabled_log_types);

	SABOT_SQL_API bool IsConsistent() const;

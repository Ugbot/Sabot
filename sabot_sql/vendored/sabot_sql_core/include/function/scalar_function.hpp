...
//                         SabotSQL
//
// sabot_sql/function/scalar_function.hpp
//
//
//===----------------------------------------------------------------------===//
...
struct FunctionLocalState {
	SABOT_SQL_API virtual ~FunctionLocalState();
...
struct ScalarFunctionInfo {
	SABOT_SQL_API virtual ~ScalarFunctionInfo();
...
public:
	SABOT_SQL_API ScalarFunction(string name, vector<LogicalType> arguments, LogicalType return_type,
	...
	SABOT_SQL_API ScalarFunction(vector<LogicalType> arguments, LogicalType return_type, scalar_function_t function,
	...
	SABOT_SQL_API bool operator==(const ScalarFunction &rhs) const;
	SABOT_SQL_API bool operator!=(const ScalarFunction &rhs) const;

	SABOT_SQL_API bool Equal(const ScalarFunction &rhs) const;

public:
	SABOT_SQL_API static void NopFunction(DataChunk &input, ExpressionState &state, Vector &result);

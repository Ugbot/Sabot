...
//                         SabotSQL
//
// sabot_sql/function/encoding_function.hpp
//
//
//===----------------------------------------------------------------------===//
...
class EncodingFunction {
public:
	SABOT_SQL_API EncodingFunction() : encode_function(nullptr), max_bytes_per_iteration(0) {
	}

	SABOT_SQL_API EncodingFunction(const string &encode_name, encode_t encode_function, const idx_t bytes_per_iteration,
	...
	SABOT_SQL_API ~EncodingFunction() {};

	SABOT_SQL_API string GetName() const {
		return name;
	}
	SABOT_SQL_API encode_t GetFunction() const {
		return encode_function;
	}
	SABOT_SQL_API idx_t GetBytesPerIteration() const {
		return max_bytes_per_iteration;
	}
	SABOT_SQL_API idx_t GetLookupBytes() const {
		return lookup_bytes;
	}

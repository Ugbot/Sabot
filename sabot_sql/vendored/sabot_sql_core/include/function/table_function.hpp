...
//                         SabotSQL
//
// sabot_sql/function/table_function.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/common/column_index.hpp"
#include "sabot_sql/common/table_column.hpp"
#include "sabot_sql/function/partition_stats.hpp"
...
struct TableFunctionInfo {
	SABOT_SQL_API virtual ~TableFunctionInfo();
...
public:
	SABOT_SQL_API virtual ~GlobalTableFunctionState();
...
struct LocalTableFunctionState {
	SABOT_SQL_API virtual ~LocalTableFunctionState();
...
public:
	...
	SABOT_SQL_API bool Equal(const TableFunction &rhs) const;
};

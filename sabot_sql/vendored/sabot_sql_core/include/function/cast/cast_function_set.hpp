...
//                         SabotSQL
//
// sabot_sql/function/cast/cast_function_set.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	SABOT_SQL_API static CastFunctionSet &Get(ClientContext &context);
	SABOT_SQL_API static CastFunctionSet &Get(DatabaseInstance &db);
	...
	SABOT_SQL_API int64_t ImplicitCastCost(optional_ptr<ClientContext> context, const LogicalType &source,
	                                    const LogicalType &target);
	SABOT_SQL_API static int64_t ImplicitCastCost(ClientContext &context, const LogicalType &source,
	                                           const LogicalType &target);
	SABOT_SQL_API static int64_t ImplicitCastCost(DatabaseInstance &db, const LogicalType &source,
	                                           const LogicalType &target);

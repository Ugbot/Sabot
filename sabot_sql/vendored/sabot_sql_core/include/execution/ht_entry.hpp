...
//                         SabotSQL
//
// sabot_sql/execution/ht_entry.hpp
//
//
//===----------------------------------------------------------------------===//
...
#if !defined(SABOT_SQL_DISABLE_POINTER_SALT) && defined(__ANDROID__)
// Google, why does Android need 18446744 TB of address space?
#define SABOT_SQL_DISABLE_POINTER_SALT
#endif
...
public:
#ifdef SABOT_SQL_DISABLE_POINTER_SALT
	//! No salt, all pointer

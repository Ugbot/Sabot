...
//                         SabotSQL
//
// sabot_sql/execution/operator/persistent/physical_insert.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/common/index_vector.hpp"
...
#include "sabot_sql/storage/table/delete_state.hpp"
#include "sabot_sql/storage/optimistic_data_writer.hpp"

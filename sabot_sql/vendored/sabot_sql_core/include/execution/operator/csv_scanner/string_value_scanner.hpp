...
//                         SabotSQL
//
// sabot_sql/execution/operator/csv_scanner/string_value_scanner.hpp
//
//
//===----------------------------------------------------------------------===//
...
//! Our dialect scanner basically goes over the CSV and actually parses the values to a SabotSQL vector of string_t

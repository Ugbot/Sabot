...
//                         SabotSQL
//
// sabot_sql/parallel/task_scheduler.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	...
	SABOT_SQL_API static TaskScheduler &GetScheduler(ClientContext &context);
	SABOT_SQL_API static TaskScheduler &GetScheduler(DatabaseInstance &db);
	...
	SABOT_SQL_API int32_t NumberOfThreads();

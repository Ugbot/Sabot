...
//                         SabotSQL
//
// sabot_sql/planner/expression/bound_cast_expression.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	...
	SABOT_SQL_API static unique_ptr<Expression> AddCastToType(ClientContext &context, unique_ptr<Expression> expr,
	...
	SABOT_SQL_API static unique_ptr<Expression> AddArrayCastToList(ClientContext &context, unique_ptr<Expression> expr);

...
#include "sabot_sql/planner/bind_context.hpp"
...
#include "sabot_sql/planner/joinside.hpp"
...
#include "sabot_sql/common/enums/copy_option_mode.hpp"
...
public:
	SABOT_SQL_API static shared_ptr<Binder> CreateBinder(ClientContext &context, optional_ptr<Binder> parent = nullptr,
...
public:
	SABOT_SQL_API BoundStatement Bind(SQLStatement &statement);
	SABOT_SQL_API BoundStatement Bind(QueryNode &node);
	...
	static string ReplaceColumnsAlias(const string &alias, const string &column_name,
	                                  optional_ptr<sabot_sql_re2::RE2> regex);

...
#include "sabot_sql/parser/simplified_token.hpp"
...
public:
	...
	SABOT_SQL_API static vector<unique_ptr<ParsedExpression>> ParseExpressionList(const string &select_list,

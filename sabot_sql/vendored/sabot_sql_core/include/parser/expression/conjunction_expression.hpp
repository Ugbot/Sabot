...
//                         SabotSQL
//
// sabot_sql/parser/expression/conjunction_expression.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	SABOT_SQL_API explicit ConjunctionExpression(ExpressionType type);
	SABOT_SQL_API ConjunctionExpression(ExpressionType type, vector<unique_ptr<ParsedExpression>> children);
	SABOT_SQL_API ConjunctionExpression(ExpressionType type, unique_ptr<ParsedExpression> left,

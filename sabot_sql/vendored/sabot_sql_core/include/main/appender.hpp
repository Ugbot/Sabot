...
protected:
	SABOT_SQL_API BaseAppender(Allocator &allocator, const AppenderType type);
	SABOT_SQL_API BaseAppender(Allocator &allocator, vector<LogicalType> types, const AppenderType type,
	                        const idx_t flush_count = DEFAULT_FLUSH_COUNT);

public:
	SABOT_SQL_API virtual ~BaseAppender();
	...
	SABOT_SQL_API void BeginRow();
	//! Finishes appending the current row.
	SABOT_SQL_API void EndRow();

	// Append functions
	template <class T>
	void Append(T value) = delete;
	SABOT_SQL_API void Append(DataChunk &target, const Value &value, idx_t col, idx_t row);

	SABOT_SQL_API void Append(const char *value, uint32_t length);
	...
	SABOT_SQL_API void AppendDataChunk(DataChunk &value);
...
public:
	SABOT_SQL_API Appender(Connection &con, const string &database_name, const string &schema_name,
	                    const string &table_name);
	SABOT_SQL_API Appender(Connection &con, const string &schema_name, const string &table_name);
	SABOT_SQL_API Appender(Connection &con, const string &table_name);
	SABOT_SQL_API ~Appender() override;
...
public:
	SABOT_SQL_API QueryAppender(Connection &con, string query, vector<LogicalType> types,
	                         vector<string> names = vector<string>(), string table_name = string());
	SABOT_SQL_API ~QueryAppender() override;
...
public:
	SABOT_SQL_API InternalAppender(ClientContext &context, TableCatalogEntry &table,
	                            const idx_t flush_count = DEFAULT_FLUSH_COUNT);
	SABOT_SQL_API ~InternalAppender() override;
...
template <>
SABOT_SQL_API void BaseAppender::Append(bool value);
template <>
SABOT_SQL_API void BaseAppender::Append(int8_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(int16_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(int32_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(int64_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(hugeint_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(uhugeint_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(uint8_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(uint16_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(uint32_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(uint64_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(float value);
template <>
SABOT_SQL_API void BaseAppender::Append(double value);
template <>
SABOT_SQL_API void BaseAppender::Append(date_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(dtime_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(timestamp_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(interval_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(const char *value);
template <>
SABOT_SQL_API void BaseAppender::Append(string_t value);
template <>
SABOT_SQL_API void BaseAppender::Append(Value value);
template <>
SABOT_SQL_API void BaseAppender::Append(std::nullptr_t value);

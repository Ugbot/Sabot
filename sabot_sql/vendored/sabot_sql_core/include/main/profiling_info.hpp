...
//                         SabotSQL
//
// sabot_sql/main/profiling_info.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "sabot_sql/common/enums/metric_type.hpp"

namespace sabot_sql_yyjson {
...
public:
	...
	void WriteMetricsToJSON(sabot_sql_yyjson::yyjson_mut_doc *doc, sabot_sql_yyjson::yyjson_mut_val *destination);

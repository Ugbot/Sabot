...
//                         SabotSQL
//
// sabot_sql/main/client_data.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	SABOT_SQL_API static ClientData &Get(ClientContext &context);
	SABOT_SQL_API static const ClientData &Get(const ClientContext &context);
};

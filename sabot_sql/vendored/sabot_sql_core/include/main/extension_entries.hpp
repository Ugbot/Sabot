...
//                         SabotSQL
//
// sabot_sql/main/extension_entries.hpp
//
//
//===----------------------------------------------------------------------===//
...
// python3 scripts/generate_extensions_function.py --extensions icu --shell build/debug/sabot_sql --extension_repository
...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"sabot_sql_proj_compiled_version", "spatial", CatalogType::SCALAR_FUNCTION_ENTRY},
    {"sabot_sql_proj_version", "spatial", CatalogType::SCALAR_FUNCTION_ENTRY},
...
// TODO: automate by passing though to script via sabot_sql

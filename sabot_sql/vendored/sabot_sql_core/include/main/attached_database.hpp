...
//                         SabotSQL
//
// sabot_sql/main/attached_database.hpp
//
//
//===----------------------------------------------------------------------===//
...
//! they have to apply to any database file type (sabot_sql, sqlite, etc.).
struct AttachOptions {
	...
	//! The file format type. The default type is a sabot_sql database file, but other file formats are possible.
	string db_type;

...
//                         SabotSQL
//
// sabot_sql/main/extension_install_info.hpp
//
//
//===----------------------------------------------------------------------===//
...
struct ExtensionRepository {
	...
	static constexpr const char *CORE_REPOSITORY_URL = "http://extensions.sabot_sql.org";
	static constexpr const char *CORE_NIGHTLY_REPOSITORY_URL = "http://nightly-extensions.sabot_sql.org";
	static constexpr const char *COMMUNITY_REPOSITORY_URL = "http://community-extensions.sabot_sql.org";

	//! Debugging repositories (target local, relative paths that are produced by SabotSQL's build system)

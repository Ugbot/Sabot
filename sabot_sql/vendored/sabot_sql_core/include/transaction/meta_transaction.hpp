...
//                         SabotSQL
//
// sabot_sql/transaction/meta_transaction.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	SABOT_SQL_API MetaTransaction(ClientContext &context, timestamp_t start_timestamp,
...
public:
	SABOT_SQL_API static MetaTransaction &Get(ClientContext &context);

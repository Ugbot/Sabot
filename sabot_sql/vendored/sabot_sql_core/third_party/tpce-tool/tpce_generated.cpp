...
template <typename T> class SabotSQLBaseLoader : public CBaseLoader<T> {
  protected:
	tpce_append_information info;

  public:
	SabotSQLBaseLoader(Connection &con, string schema, string table) :
...
class SabotSQLAccountPermissionLoad : public SabotSQLBaseLoader<ACCOUNT_PERMISSION_ROW> {
public:
	SabotSQLAccountPermissionLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLAddressLoad : public SabotSQLBaseLoader<ADDRESS_ROW> {
public:
	SabotSQLAddressLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLBrokerLoad : public SabotSQLBaseLoader<BROKER_ROW> {
public:
	SabotSQLBrokerLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLCashTransactionLoad : public SabotSQLBaseLoader<CASH_TRANSACTION_ROW> {
public:
	SabotSQLCashTransactionLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLChargeLoad : public SabotSQLBaseLoader<CHARGE_ROW> {
public:
	SabotSQLChargeLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLCommissionRateLoad : public SabotSQLBaseLoader<COMMISSION_RATE_ROW> {
public:
	SabotSQLCommissionRateLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLCompanyLoad : public SabotSQLBaseLoader<COMPANY_ROW> {
public:
	SabotSQLCompanyLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLCompanyCompetitorLoad : public SabotSQLBaseLoader<COMPANY_COMPETITOR_ROW> {
public:
	SabotSQLCompanyCompetitorLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLCustomerLoad : public SabotSQLBaseLoader<CUSTOMER_ROW> {
public:
	SabotSQLCustomerLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLCustomerAccountLoad : public SabotSQLBaseLoader<CUSTOMER_ACCOUNT_ROW> {
public:
	SabotSQLCustomerAccountLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLCustomerTaxrateLoad : public SabotSQLBaseLoader<CUSTOMER_TAXRATE_ROW> {
public:
	SabotSQLCustomerTaxrateLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLDailyMarketLoad : public SabotSQLBaseLoader<DAILY_MARKET_ROW> {
public:
	SabotSQLDailyMarketLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLExchangeLoad : public SabotSQLBaseLoader<EXCHANGE_ROW> {
public:
	SabotSQLExchangeLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLFinancialLoad : public SabotSQLBaseLoader<FINANCIAL_ROW> {
public:
	SabotSQLFinancialLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLHoldingLoad : public SabotSQLBaseLoader<HOLDING_ROW> {
public:
	SabotSQLHoldingLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLHoldingHistoryLoad : public SabotSQLBaseLoader<HOLDING_HISTORY_ROW> {
public:
	SabotSQLHoldingHistoryLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLHoldingSummaryLoad : public SabotSQLBaseLoader<HOLDING_SUMMARY_ROW> {
public:
	SabotSQLHoldingSummaryLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLIndustryLoad : public SabotSQLBaseLoader<INDUSTRY_ROW> {
public:
	SabotSQLIndustryLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLLastTradeLoad : public SabotSQLBaseLoader<LAST_TRADE_ROW> {
public:
	SabotSQLLastTradeLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLNewsItemLoad : public SabotSQLBaseLoader<NEWS_ITEM_ROW> {
public:
	SabotSQLNewsItemLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLNewsXRefLoad : public SabotSQLBaseLoader<NEWS_XREF_ROW> {
public:
	SabotSQLNewsXRefLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLSectorLoad : public SabotSQLBaseLoader<SECTOR_ROW> {
public:
	SabotSQLSectorLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLSecurityLoad : public SabotSQLBaseLoader<SECURITY_ROW> {
public:
	SabotSQLSecurityLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLSettlementLoad : public SabotSQLBaseLoader<SETTLEMENT_ROW> {
public:
	SabotSQLSettlementLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLStatusTypeLoad : public SabotSQLBaseLoader<STATUS_TYPE_ROW> {
public:
	SabotSQLStatusTypeLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLTaxRateLoad : public SabotSQLBaseLoader<TAX_RATE_ROW> {
public:
	SabotSQLTaxRateLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLTradeLoad : public SabotSQLBaseLoader<TRADE_ROW> {
public:
	SabotSQLTradeLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLTradeHistoryLoad : public SabotSQLBaseLoader<TRADE_HISTORY_ROW> {
public:
	SabotSQLTradeHistoryLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLTradeRequestLoad : public SabotSQLBaseLoader<TRADE_REQUEST_ROW> {
public:
	SabotSQLTradeRequestLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLTradeTypeLoad : public SabotSQLBaseLoader<TRADE_TYPE_ROW> {
public:
	SabotSQLTradeTypeLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLWatchItemLoad : public SabotSQLBaseLoader<WATCH_ITEM_ROW> {
public:
	SabotSQLWatchItemLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLWatchListLoad : public SabotSQLBaseLoader<WATCH_LIST_ROW> {
public:
	SabotSQLWatchListLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
class SabotSQLZipCodeLoad : public SabotSQLBaseLoader<ZIP_CODE_ROW> {
public:
	SabotSQLZipCodeLoad(Connection &con, string schema, string table) :
		SabotSQLBaseLoader(con, schema, table) {
...
SabotSQLLoaderFactory::CreateAccountPermissionLoader() {
	return new SabotSQLAccountPermissionLoad(con, schema, "account_permission" + suffix);
}

CBaseLoader<ADDRESS_ROW> *
SabotSQLLoaderFactory::CreateAddressLoader() {
	return new SabotSQLAddressLoad(con, schema, "address" + suffix);
}

CBaseLoader<BROKER_ROW> *
SabotSQLLoaderFactory::CreateBrokerLoader() {
	return new SabotSQLBrokerLoad(con, schema, "broker" + suffix);
}

CBaseLoader<CASH_TRANSACTION_ROW> *
SabotSQLLoaderFactory::CreateCashTransactionLoader() {
	return new SabotSQLCashTransactionLoad(con, schema, "cash_transaction" + suffix);
}

CBaseLoader<CHARGE_ROW> *
SabotSQLLoaderFactory::CreateChargeLoader() {
	return new SabotSQLChargeLoad(con, schema, "charge" + suffix);
}

CBaseLoader<COMMISSION_RATE_ROW> *
SabotSQLLoaderFactory::CreateCommissionRateLoader() {
	return new SabotSQLCommissionRateLoad(con, schema, "commission_rate" + suffix);
}

CBaseLoader<COMPANY_ROW> *
SabotSQLLoaderFactory::CreateCompanyLoader() {
	return new SabotSQLCompanyLoad(con, schema, "company" + suffix);
}

CBaseLoader<COMPANY_COMPETITOR_ROW> *
SabotSQLLoaderFactory::CreateCompanyCompetitorLoader() {
	return new SabotSQLCompanyCompetitorLoad(con, schema, "company_competitor" + suffix);
}

CBaseLoader<CUSTOMER_ROW> *
SabotSQLLoaderFactory::CreateCustomerLoader() {
	return new SabotSQLCustomerLoad(con, schema, "customer" + suffix);
}

CBaseLoader<CUSTOMER_ACCOUNT_ROW> *
SabotSQLLoaderFactory::CreateCustomerAccountLoader() {
	return new SabotSQLCustomerAccountLoad(con, schema, "customer_account" + suffix);
}

CBaseLoader<CUSTOMER_TAXRATE_ROW> *
SabotSQLLoaderFactory::CreateCustomerTaxrateLoader() {
	return new SabotSQLCustomerTaxrateLoad(con, schema, "customer_taxrate" + suffix);
}

CBaseLoader<DAILY_MARKET_ROW> *
SabotSQLLoaderFactory::CreateDailyMarketLoader() {
	return new SabotSQLDailyMarketLoad(con, schema, "daily_market" + suffix);
}

CBaseLoader<EXCHANGE_ROW> *
SabotSQLLoaderFactory::CreateExchangeLoader() {
	return new SabotSQLExchangeLoad(con, schema, "exchange" + suffix);
}

CBaseLoader<FINANCIAL_ROW> *
SabotSQLLoaderFactory::CreateFinancialLoader() {
	return new SabotSQLFinancialLoad(con, schema, "financial" + suffix);
}

CBaseLoader<HOLDING_ROW> *
SabotSQLLoaderFactory::CreateHoldingLoader() {
	return new SabotSQLHoldingLoad(con, schema, "holding" + suffix);
}

CBaseLoader<HOLDING_HISTORY_ROW> *
SabotSQLLoaderFactory::CreateHoldingHistoryLoader() {
	return new SabotSQLHoldingHistoryLoad(con, schema, "holding_history" + suffix);
}

CBaseLoader<HOLDING_SUMMARY_ROW> *
SabotSQLLoaderFactory::CreateHoldingSummaryLoader() {
	return new SabotSQLHoldingSummaryLoad(con, schema, "holding_summary" + suffix);
}

CBaseLoader<INDUSTRY_ROW> *
SabotSQLLoaderFactory::CreateIndustryLoader() {
	return new SabotSQLIndustryLoad(con, schema, "industry" + suffix);
}

CBaseLoader<LAST_TRADE_ROW> *
SabotSQLLoaderFactory::CreateLastTradeLoader() {
	return new SabotSQLLastTradeLoad(con, schema, "last_trade" + suffix);
}

CBaseLoader<NEWS_ITEM_ROW> *
SabotSQLLoaderFactory::CreateNewsItemLoader() {
	return new SabotSQLNewsItemLoad(con, schema, "news_item" + suffix);
}

CBaseLoader<NEWS_XREF_ROW> *
SabotSQLLoaderFactory::CreateNewsXRefLoader() {
	return new SabotSQLNewsXRefLoad(con, schema, "news_xref" + suffix);
}

CBaseLoader<SECTOR_ROW> *
SabotSQLLoaderFactory::CreateSectorLoader() {
	return new SabotSQLSectorLoad(con, schema, "sector" + suffix);
}

CBaseLoader<SECURITY_ROW> *
SabotSQLLoaderFactory::CreateSecurityLoader() {
	return new SabotSQLSecurityLoad(con, schema, "security" + suffix);
}

CBaseLoader<SETTLEMENT_ROW> *
SabotSQLLoaderFactory::CreateSettlementLoader() {
	return new SabotSQLSettlementLoad(con, schema, "settlement" + suffix);
}

CBaseLoader<STATUS_TYPE_ROW> *
SabotSQLLoaderFactory::CreateStatusTypeLoader() {
	return new SabotSQLStatusTypeLoad(con, schema, "status_type" + suffix);
}

CBaseLoader<TAX_RATE_ROW> *
SabotSQLLoaderFactory::CreateTaxRateLoader() {
	return new SabotSQLTaxRateLoad(con, schema, "tax_rate" + suffix);
}

CBaseLoader<TRADE_ROW> *
SabotSQLLoaderFactory::CreateTradeLoader() {
	return new SabotSQLTradeLoad(con, schema, "trade" + suffix);
}

CBaseLoader<TRADE_HISTORY_ROW> *
SabotSQLLoaderFactory::CreateTradeHistoryLoader() {
	return new SabotSQLTradeHistoryLoad(con, schema, "trade_history" + suffix);
}

CBaseLoader<TRADE_REQUEST_ROW> *
SabotSQLLoaderFactory::CreateTradeRequestLoader() {
	return new SabotSQLTradeRequestLoad(con, schema, "trade_request" + suffix);
}

CBaseLoader<TRADE_TYPE_ROW> *
SabotSQLLoaderFactory::CreateTradeTypeLoader() {
	return new SabotSQLTradeTypeLoad(con, schema, "trade_type" + suffix);
}

CBaseLoader<WATCH_ITEM_ROW> *
SabotSQLLoaderFactory::CreateWatchItemLoader() {
	return new SabotSQLWatchItemLoad(con, schema, "watch_item" + suffix);
}

CBaseLoader<WATCH_LIST_ROW> *
SabotSQLLoaderFactory::CreateWatchListLoader() {
	return new SabotSQLWatchListLoad(con, schema, "watch_list" + suffix);
}

CBaseLoader<ZIP_CODE_ROW> *
SabotSQLLoaderFactory::CreateZipCodeLoader() {
	return new SabotSQLZipCodeLoad(con, schema, "zip_code" + suffix);
}
...
void CreateTPCESchema(sabot_sql::SabotSQL &db, sabot_sql::Connection &con, std::string &schema, std::string &suffix) {

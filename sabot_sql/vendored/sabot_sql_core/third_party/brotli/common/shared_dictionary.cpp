...
void sabot_sql_brotli::BrotliSharedDictionaryDestroyInstance(
    BrotliSharedDictionary* dict) {
  if (!dict) {
    return;
  } else {
...
BROTLI_BOOL sabot_sql_brotli::BrotliSharedDictionaryAttach(
...
BrotliSharedDictionary* sabot_sql_brotli::BrotliSharedDictionaryCreateInstance(
  ...
  dict->alloc_func = alloc_func ? alloc_func :  sabot_sql_brotli::BrotliDefaultAllocFunc;
  dict->free_func = free_func ? free_func :  sabot_sql_brotli::BrotliDefaultFreeFunc;

...
const BrotliTransforms* sabot_sql_brotli::BrotliGetTransforms(void) {
...
int sabot_sql_brotli::BrotliTransformDictionaryWord(uint8_t* dst, const uint8_t* word, int len,

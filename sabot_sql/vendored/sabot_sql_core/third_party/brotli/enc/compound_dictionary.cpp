...
PreparedDictionary* sabot_sql_brotli::CreatePreparedDictionary(MemoryManager* m,
...
void sabot_sql_brotli::DestroyPreparedDictionary(MemoryManager* m,
    PreparedDictionary* dictionary) {
  if (!dictionary) return;
  BROTLI_FREE(m, dictionary);
}

BROTLI_BOOL sabot_sql_brotli::AttachPreparedDictionary(

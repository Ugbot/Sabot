...
void sabot_sql_brotli::BrotliStoreHuffmanTree(const uint8_t* depths, size_t num,
                            HuffmanTree* tree,
                            size_t* storage_ix, uint8_t* storage) {
...
void sabot_sql_brotli::BrotliBuildAndStoreHuffmanTreeFast(HuffmanTree* tree,
...
void sabot_sql_brotli::BrotliStoreMetaBlock(MemoryManager* m,
...
void sabot_sql_brotli::BrotliStoreMetaBlockTrivial(MemoryManager* m,
    const uint8_t* input, size_t start_pos, size_t length, size_t mask,
...
void sabot_sql_brotli::BrotliStoreMetaBlockFast(MemoryManager* m,
    const uint8_t* input, size_t start_pos, size_t length, size_t mask,
    BROTLI_BOOL is_last, const BrotliEncoderParams* params,
    const Command* commands, size_t n_commands,
    size_t* storage_ix, uint8_t* storage) {
...
/* This is for storing uncompressed blocks (simple raw storage of
   bytes-as-bytes). */
void sabot_sql_brotli::BrotliStoreUncompressedMetaBlock(BROTLI_BOOL is_final_block,

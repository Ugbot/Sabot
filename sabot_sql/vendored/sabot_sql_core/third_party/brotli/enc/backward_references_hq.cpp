...
void sabot_sql_brotli::BrotliInitZopfliNodes(ZopfliNode* array, size_t length) {
  ZopfliNode stub;
  size_t i;
  stub.length = 1;
  stub.distance = 0;
...
void sabot_sql_brotli::BrotliZopfliCreateCommands(const size_t num_bytes,
...
/* REQUIRES: nodes != NULL and len(nodes) >= num_bytes + 1 */
size_t sabot_sql_brotli::BrotliZopfliComputeShortestPath(MemoryManager* m, size_t num_bytes,
...
void sabot_sql_brotli::BrotliCreateZopfliBackwardReferences(MemoryManager* m, size_t num_bytes,
    size_t position, const uint8_t* ringbuffer, size_t ringbuffer_mask,
    ContextLut literal_context_lut, const BrotliEncoderParams* params,
...
void sabot_sql_brotli::BrotliCreateHqZopfliBackwardReferences(MemoryManager* m, size_t num_bytes,
    size_t position, const uint8_t* ringbuffer, size_t ringbuffer_mask,
    ContextLut literal_context_lut, const BrotliEncoderParams* params,
    Hasher* hasher, int* dist_cache, size_t* last_insert_len,
    Command* commands, size_t* num_commands, size_t* num_literals) {

...
void sabot_sql_brotli::BrotliInitSharedEncoderDictionary(SharedEncoderDictionary* dict) {
...
void sabot_sql_brotli::BrotliCleanupSharedEncoderDictionary(MemoryManager* m,
...
ManagedDictionary* sabot_sql_brotli::BrotliCreateManagedDictionary(
...
void sabot_sql_brotli::BrotliDestroyManagedDictionary(ManagedDictionary* dictionary) {

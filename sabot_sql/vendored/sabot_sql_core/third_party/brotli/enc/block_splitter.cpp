...
void sabot_sql_brotli::BrotliInitBlockSplit(BlockSplit* self) {
  self->num_types = 0;
  self->num_blocks = 0;
  self->types = 0;
  self->lengths = 0;
...
void sabot_sql_brotli::BrotliDestroyBlockSplit(MemoryManager* m, BlockSplit* self) {
...
void sabot_sql_brotli::BrotliSplitBlock(MemoryManager* m,
                      const Command* cmds,
                      const size_t num_commands,
                      const uint8_t* data,
                      const size_t pos,

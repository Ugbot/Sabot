...
void sabot_sql_brotli::BrotliInitDistanceParams(BrotliDistanceParams* dist_params,
...
void sabot_sql_brotli::BrotliBuildMetaBlock(MemoryManager* m,
...
void sabot_sql_brotli::BrotliBuildMetaBlockGreedy(MemoryManager* m,
                                const uint8_t* ringbuffer,
                                size_t pos,
                                size_t mask,
                                uint8_t prev_byte,
...
void sabot_sql_brotli::BrotliOptimizeHistograms(uint32_t num_distance_codes,
                              MetaBlockSplit* mb) {

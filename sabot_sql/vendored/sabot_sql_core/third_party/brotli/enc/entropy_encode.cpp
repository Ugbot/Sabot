...
const size_t sabot_sql_brotli::kBrotliShellGaps[] = {132, 57, 23, 10, 4, 1};

BROTLI_BOOL sabot_sql_brotli::BrotliSetDepth(
...
void sabot_sql_brotli::BrotliCreateHuffmanTree(const uint32_t* data,
                             const size_t length,
...
void sabot_sql_brotli::BrotliOptimizeHuffmanCountsForRle(size_t length, uint32_t* counts,
...
void sabot_sql_brotli::BrotliWriteHuffmanTree(const uint8_t* depth,
                            size_t length,
                            size_t* tree_size,
                            uint8_t* tree,
                            uint8_t* extra_bits_data) {
...
void sabot_sql_brotli::BrotliConvertBitDepthsToSymbols(const uint8_t* depth,
                                     size_t len,
                                     uint16_t* bits) {

...
typedef struct PGIntervalConstant {
	PGNodeTag type;
	int val_type;         /* interval constant type, either sabot_sql_libpgquery::T_PGString, sabot_sql_libpgquery::T_PGInteger or sabot_sql_libpgquery::T_PGAExpr */
	char *sval;           /* sabot_sql_libpgquery::T_PGString */
	int ival;             /* sabot_sql_libpgquery::T_PGString */
	PGNode *eval;         /* sabot_sql_libpgquery::T_PGAExpr */

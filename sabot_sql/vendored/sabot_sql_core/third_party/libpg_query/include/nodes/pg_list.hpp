 ...
 *
 *	sabot_sql_libpgquery::T_PGList: lists of pointers
 *		(in practice usually pointers to Nodes, but not always;
 *		declared as "void *" to minimize casting annoyances)
 *	sabot_sql_libpgquery::T_PGIntList: lists of integers
 *	sabot_sql_libpgquery::T_PGOidList: lists of Oids
 *
...
typedef struct PGList {
	PGNodeTag		type;			/* sabot_sql_libpgquery::T_PGList, sabot_sql_libpgquery::T_PGIntList, or sabot_sql_libpgquery::T_PGOidList */
	int			length;
	PGListCell   *head;
	PGListCell   *tail;
} PGList;

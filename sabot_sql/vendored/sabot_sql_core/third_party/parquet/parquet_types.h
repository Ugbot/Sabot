...
namespace apache = sabot_sql_apache;
...
class SizeStatistics : public virtual ::apache::thrift::TBase {
 public:
   ...
   * 
   */
  sabot_sql::vector<int64_t>  repetition_level_histogram;
  /**
   ...
   * 
   */
  sabot_sql::vector<int64_t>  definition_level_histogram;

  _SizeStatistics__isset __isset;

  void __set_unencoded_byte_array_data_bytes(const int64_t val);

  void __set_repetition_level_histogram(const sabot_sql::vector<int64_t> & val);

  void __set_definition_level_histogram(const sabot_sql::vector<int64_t> & val);
...
class GeospatialStatistics : public virtual ::apache::thrift::TBase {
 public:
   ...
   */
  sabot_sql::vector<int32_t>  geospatial_types;

  _GeospatialStatistics__isset __isset;

  void __set_bbox(const BoundingBox& val);

  void __set_geospatial_types(const sabot_sql::vector<int32_t> & val);
...
class ColumnMetaData : public virtual ::apache::thrift::TBase {
 public:
   ...
   */
  sabot_sql::vector<Encoding::type>  encodings;
  /**
   * Path in schema *
   */
  sabot_sql::vector<std::string>  path_in_schema;
  /**
   * Compression codec *
   * 
   ...
   */
  sabot_sql::vector<KeyValue>  key_value_metadata;
  /**
   ...
   */
  sabot_sql::vector<PageEncodingStats>  encoding_stats;
  /**
  ...
  void __set_encodings(const sabot_sql::vector<Encoding::type> & val);

  void __set_path_in_schema(const sabot_sql::vector<std::string> & val);
  ...
  void __set_key_value_metadata(const sabot_sql::vector<KeyValue> & val);
  ...
  void __set_encoding_stats(const sabot_sql::vector<PageEncodingStats> & val);
...
class RowGroup : public virtual ::apache::thrift::TBase {
 public:
   ...
   * 
   */
  sabot_sql::vector<ColumnChunk>  columns;
  /**
   ...
   */
  sabot_sql::vector<SortingColumn>  sorting_columns;
  /**
  ...
  void __set_columns(const sabot_sql::vector<ColumnChunk> & val);

  void __set_total_byte_size(const int64_t val);

  void __set_num_rows(const int64_t val);

  void __set_sorting_columns(const sabot_sql::vector<SortingColumn> & val);
...
class OffsetIndex : public virtual ::apache::thrift::TBase {
 public:
   ...
   */
  sabot_sql::vector<PageLocation>  page_locations;
  /**
   ...
   */
  sabot_sql::vector<int64_t>  unencoded_byte_array_data_bytes;

  _OffsetIndex__isset __isset;

  void __set_page_locations(const sabot_sql::vector<PageLocation> & val);

  void __set_unencoded_byte_array_data_bytes(const sabot_sql::vector<int64_t> & val);
...
class ColumnIndex : public virtual ::apache::thrift::TBase {
 public:
   ...
   */
  sabot_sql::vector<bool>  null_pages;
  /**
   ...
   */
  sabot_sql::vector<std::string>  min_values;
  sabot_sql::vector<std::string>  max_values;
  /**
   ...
   * null counts are 0.
   */
  sabot_sql::vector<int64_t>  null_counts;
  /**
   ...
   * 
   */
  sabot_sql::vector<int64_t>  repetition_level_histograms;
  /**
   * Same as repetition_level_histograms except for definitions levels.
   * 
   */
  sabot_sql::vector<int64_t>  definition_level_histograms;

  _ColumnIndex__isset __isset;

  void __set_null_pages(const sabot_sql::vector<bool> & val);

  void __set_min_values(const sabot_sql::vector<std::string> & val);

  void __set_max_values(const sabot_sql::vector<std::string> & val);

  void __set_boundary_order(const BoundaryOrder::type val);

  void __set_null_counts(const sabot_sql::vector<int64_t> & val);

  void __set_repetition_level_histograms(const sabot_sql::vector<int64_t> & val);

  void __set_definition_level_histograms(const sabot_sql::vector<int64_t> & val);
...
class FileMetaData : public virtual ::apache::thrift::TBase {
 public:
   ...
   */
  sabot_sql::vector<SchemaElement>  schema;
  /**
   ...
   */
  sabot_sql::vector<RowGroup>  row_groups;
  /**
   * Optional key/value metadata *
   */
  sabot_sql::vector<KeyValue>  key_value_metadata;
   ...
   */
  sabot_sql::vector<ColumnOrder>  column_orders;
  /**
  ...
  void __set_schema(const sabot_sql::vector<SchemaElement> & val);

  void __set_num_rows(const int64_t val);

  void __set_row_groups(const sabot_sql::vector<RowGroup> & val);

  void __set_key_value_metadata(const sabot_sql::vector<KeyValue> & val);

  void __set_created_by(const std::string& val);

  void __set_column_orders(const sabot_sql::vector<ColumnOrder> & val);

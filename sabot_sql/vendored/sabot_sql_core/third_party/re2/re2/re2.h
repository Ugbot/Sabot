...
class RE2 {
 public:
  ...
  sabot_sql_re2::Regexp* Regexp() const { return entire_regexp_; }
 ...
 private:
  ...
  sabot_sql_re2::Prog* ReverseProg() const;

  // First cache line is relatively cold fields.
  const std::string* pattern_;    // string regular expression
  Options options_;               // option flags
  sabot_sql_re2::Regexp* entire_regexp_;    // parsed regular expression
  sabot_sql_re2::Regexp* suffix_regexp_;    // parsed regular expression, prefix_ removed
  ...
  sabot_sql_re2::Prog* prog_;               // compiled program for regexp

  // Reverse Prog for DFA execution only
  mutable sabot_sql_re2::Prog* rprog_;
...
using sabot_sql_re2::RE2;
using sabot_sql_re2::LazyRE2;

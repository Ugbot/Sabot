...
inline sabot_sql_fmt::internal::null<> strerror_r(int, char*, ...) { return {}; }
inline sabot_sql_fmt::internal::null<> strerror_s(char*, std::size_t, ...) { return {}; }
...
FMT_FUNC void internal::error_handler::on_error(std::string message) {
  FMT_THROW(sabot_sql::InvalidInputException(message));
}

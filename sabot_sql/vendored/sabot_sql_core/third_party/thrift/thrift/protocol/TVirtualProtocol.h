...
#ifndef _SABOT_SQL_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_
#define _SABOT_SQL_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1

#include "thrift/protocol/TProtocol.h"
#include "sabot_sql/common/vector.hpp"

namespace sabot_sql_apache {
namespace thrift {
namespace protocol {

using sabot_sql_apache::thrift::transport::TTransport;
...
public:
  ...
  uint32_t readBool(sabot_sql::vector<bool>::reference value) {
    (void)value;
    throw TProtocolException(TProtocolException::NOT_IMPLEMENTED,
                             "this protocol does not support reading (yet).");
  }
  ...
  uint32_t skip(TType type) { return ::sabot_sql_apache::thrift::protocol::skip(*this, type); }
...
public:
  ...
  uint32_t readBool_virt(sabot_sql::vector<bool>::reference value) override {
    return static_cast<Protocol_*>(this)->readBool(value);
  }
  ...
  uint32_t skip(TType type) {
    ...
    return ::sabot_sql_apache::thrift::protocol::skip(*prot, type);
  }

  /*
   * Provide a default readBool() implementation for use with
   * sabot_sql::vector<bool>, that behaves the same as reading into a normal bool.
   *
...
} // sabot_sql_apache::thrift::protocol

#endif // #define _SABOT_SQL_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1

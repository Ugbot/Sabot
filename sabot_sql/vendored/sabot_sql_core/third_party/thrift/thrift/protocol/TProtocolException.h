...
#ifndef _SABOT_SQL_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
#define _SABOT_SQL_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_ 1
 ...
 *
 */
class TProtocolException : public sabot_sql_apache::thrift::TException {
public:
  /**
  ...
  TProtocolException() : sabot_sql_apache::thrift::TException(), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type) : sabot_sql_apache::thrift::TException(), type_(type) {}
...
#endif // #ifndef _SABOT_SQL_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_

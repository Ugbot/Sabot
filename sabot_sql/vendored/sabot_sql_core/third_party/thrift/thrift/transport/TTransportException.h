...
#ifndef _SABOT_SQL_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_
#define _SABOT_SQL_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_ 1
 ...
 *
 */
class TTransportException : public sabot_sql_apache::thrift::TException {
public:
  /**
  ...
  TTransportException() : sabot_sql_apache::thrift::TException(), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type) : sabot_sql_apache::thrift::TException(), type_(type) {}

  TTransportException(const std::string& message)
    : sabot_sql_apache::thrift::TException(message), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type, const std::string& message)
    : sabot_sql_apache::thrift::TException(message), type_(type) {}
...
} // sabot_sql_apache::thrift::transport

#endif // #ifndef _SABOT_SQL_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_

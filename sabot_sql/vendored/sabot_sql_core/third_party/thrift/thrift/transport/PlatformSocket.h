...
#ifndef _SABOT_SQL_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
#  define _SABOT_SQL_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_
...
#endif // _SABOT_SQL_THRIFT_TRANSPORT_PLATFORM_SOCKET_H_

...
#ifndef _SABOT_SQL_THRIFT_TOSTRING_H_
#define _SABOT_SQL_THRIFT_TOSTRING_H_ 1
...
template <typename T>
std::string to_string(const sabot_sql::vector<T>& t);
...
} // sabot_sql_apache::thrift

#endif // _SABOT_SQL_THRIFT_TOSTRING_H_

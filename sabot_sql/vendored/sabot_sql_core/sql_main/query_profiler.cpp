...
#include "sabot_sql/common/fstream.hpp"
...
#include "sabot_sql/common/tree_renderer/text_tree_renderer.hpp"
#include "sabot_sql/execution/expression_executor.hpp"
#include "sabot_sql/execution/operator/helper/physical_execute.hpp"
#include "sabot_sql/execution/operator/scan/physical_table_scan.hpp"
...
ProfilerPrintFormat QueryProfiler::GetPrintFormat(ExplainFormat format) const {
	...
	case ExplainFormat::DEFAULT:
		...
		SABOT_SQL_EXPLICIT_FALLTHROUGH;

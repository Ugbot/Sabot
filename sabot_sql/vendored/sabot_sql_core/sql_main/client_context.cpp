...
#include "sabot_sql/catalog/catalog_search_path.hpp"
#include "sabot_sql/common/error_data.hpp"
#include "sabot_sql/common/exception/transaction_exception.hpp"
#include "sabot_sql/common/progress_bar/progress_bar.hpp"
...
#include "sabot_sql/main/client_context_file_opener.hpp"
...
#include "sabot_sql/transaction/meta_transaction.hpp"
...
void ClientContext::BeginQueryInternal(ClientContextLock &lock, const string &query) {
	...
	SABOT_SQL_LOG(*this, QueryLogType, query);
}
...
unique_ptr<PendingQueryResult> ClientContext::PendingStatementOrPreparedStatementInternal(
	...
	if (statement && config.query_verification_enabled) {
		...
		default: {
#ifndef SABOT_SQL_ALTERNATIVE_VERIFY
...
#ifdef SABOT_SQL_FORCE_QUERY_LOG
		try {
			string log_path(SABOT_SQL_FORCE_QUERY_LOG);
...
void ClientContext::Append(TableDescription &description, ColumnDataCollection &collection,
	...
	string table_name = "__sabot_sql_internal_appended_data";

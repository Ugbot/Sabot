...
#include "sabot_sql/main/relation/aggregate_relation.hpp"
#include "sabot_sql/main/relation/cross_product_relation.hpp"
#include "sabot_sql/main/relation/distinct_relation.hpp"
#include "sabot_sql/main/relation/explain_relation.hpp"
#include "sabot_sql/main/relation/filter_relation.hpp"
#include "sabot_sql/main/relation/insert_relation.hpp"
#include "sabot_sql/main/relation/limit_relation.hpp"
#include "sabot_sql/main/relation/order_relation.hpp"
#include "sabot_sql/main/relation/projection_relation.hpp"
#include "sabot_sql/main/relation/setop_relation.hpp"
#include "sabot_sql/main/relation/subquery_relation.hpp"
#include "sabot_sql/main/relation/table_function_relation.hpp"
#include "sabot_sql/main/relation/create_table_relation.hpp"
#include "sabot_sql/main/relation/create_view_relation.hpp"
...
#include "sabot_sql/main/relation/join_relation.hpp"
#include "sabot_sql/main/relation/value_relation.hpp"
...
shared_ptr<Relation> Relation::WriteCSVRel(const string &csv_file, case_insensitive_map_t<vector<Value>> options) {
	return make_shared_ptr<sabot_sql::WriteCSVRelation>(shared_from_this(), csv_file, std::move(options));
}
...
shared_ptr<Relation> Relation::WriteParquetRel(const string &parquet_file,
	...
	auto write_parquet =
	    make_shared_ptr<sabot_sql::WriteParquetRelation>(shared_from_this(), parquet_file, std::move(options));

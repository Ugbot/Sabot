...
void sabot_sql::BaseAppender::Append(DataChunk &target, const Value &value, idx_t col, idx_t row) {
...
void sabot_sql::Appender::AppendDefault(DataChunk &chunk, idx_t col, idx_t row) {

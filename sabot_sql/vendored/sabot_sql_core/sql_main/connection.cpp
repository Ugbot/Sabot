...
#include "sabot_sql/main/relation/table_relation.hpp"
#include "sabot_sql/main/relation/value_relation.hpp"
#include "sabot_sql/main/relation/view_relation.hpp"
...
Connection::Connection(SabotSQL &database) : Connection(*database.instance) {
}

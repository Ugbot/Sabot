...
#include "sabot_sql/common/serializer/binary_deserializer.hpp"
#include "sabot_sql/common/serializer/buffered_file_reader.hpp"
...
#ifndef SABOT_SQL_EXTENSION_CORE_FUNCTIONS_LINKED
#define SABOT_SQL_EXTENSION_CORE_FUNCTIONS_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_ICU_LINKED
#define SABOT_SQL_EXTENSION_ICU_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_EXCEL_LINKED
#define SABOT_SQL_EXTENSION_EXCEL_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_PARQUET_LINKED
#define SABOT_SQL_EXTENSION_PARQUET_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_TPCH_LINKED
#define SABOT_SQL_EXTENSION_TPCH_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_TPCDS_LINKED
#define SABOT_SQL_EXTENSION_TPCDS_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_HTTPFS_LINKED
#define SABOT_SQL_EXTENSION_HTTPFS_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_JSON_LINKED
#define SABOT_SQL_EXTENSION_JSON_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_JEMALLOC_LINKED
#define SABOT_SQL_EXTENSION_JEMALLOC_LINKED false
#endif

#ifndef SABOT_SQL_EXTENSION_AUTOCOMPLETE_LINKED
#define SABOT_SQL_EXTENSION_AUTOCOMPLETE_LINKED false
#endif

// Load the generated header file containing our list of extension headers
#if defined(GENERATED_EXTENSION_HEADERS) && GENERATED_EXTENSION_HEADERS && !defined(SABOT_SQL_AMALGAMATION)
#include "sabot_sql/main/extension/generated_extension_loader.hpp"
#else
// TODO: rewrite package_build.py to allow also loading out-of-tree extensions in non-cmake builds, after that
//		 these can be removed
#if SABOT_SQL_EXTENSION_CORE_FUNCTIONS_LINKED
#include "core_functions_extension.hpp"
#endif

#if SABOT_SQL_EXTENSION_ICU_LINKED
#include "icu_extension.hpp"
#endif

#if SABOT_SQL_EXTENSION_PARQUET_LINKED
#include "parquet_extension.hpp"
#endif

#if SABOT_SQL_EXTENSION_TPCH_LINKED
#include "tpch_extension.hpp"
#endif

#if SABOT_SQL_EXTENSION_TPCDS_LINKED
#include "tpcds_extension.hpp"
#endif

#if SABOT_SQL_EXTENSION_JSON_LINKED
#include "json_extension.hpp"
#endif

#if SABOT_SQL_EXTENSION_JEMALLOC_LINKED
#include "jemalloc_extension.hpp"
#endif

#if SABOT_SQL_EXTENSION_AUTOCOMPLETE_LINKED
...
static const DefaultExtension internal_extensions[] = {
    {"core_functions", "Core function library", SABOT_SQL_EXTENSION_CORE_FUNCTIONS_LINKED},
    {"icu", "Adds support for time zones and collations using the ICU library", SABOT_SQL_EXTENSION_ICU_LINKED},
    {"excel", "Adds support for Excel-like format strings", SABOT_SQL_EXTENSION_EXCEL_LINKED},
    {"parquet", "Adds support for reading and writing parquet files", SABOT_SQL_EXTENSION_PARQUET_LINKED},
    {"tpch", "Adds TPC-H data generation and query support", SABOT_SQL_EXTENSION_TPCH_LINKED},
    {"tpcds", "Adds TPC-DS data generation and query support", SABOT_SQL_EXTENSION_TPCDS_LINKED},
    {"httpfs", "Adds support for reading and writing files over a HTTP(S) connection", SABOT_SQL_EXTENSION_HTTPFS_LINKED},
    {"json", "Adds support for JSON operations", SABOT_SQL_EXTENSION_JSON_LINKED},
    {"jemalloc", "Overwrites system allocator with JEMalloc", SABOT_SQL_EXTENSION_JEMALLOC_LINKED},
    {"autocomplete", "Adds support for autocomplete in the shell", SABOT_SQL_EXTENSION_AUTOCOMPLETE_LINKED},
    ...
    {"azure", "Adds a filesystem abstraction for Azure blob storage to SabotSQL", false},
    ...
    {"ui", "Adds local UI for SabotSQL", false},
...
#ifdef SABOT_SQL_DISABLE_EXTENSION_LOAD
	return false;
#endif
...
vector<ExtensionUpdateResult> ExtensionHelper::UpdateExtensions(ClientContext &context) {
	...
	fs.ListFiles(ext_directory, [&](const string &path, bool is_directory) {
		if (!StringUtil::EndsWith(path, ".sabot_sql_extension")) {
			return;
		}
...
ExtensionUpdateResult ExtensionHelper::UpdateExtension(ClientContext &context, const string &extension_name) {
	...
	auto full_extension_path = fs.JoinPath(ext_directory, extension_name + ".sabot_sql_extension");
...
void ExtensionHelper::AutoLoadExtension(DatabaseInstance &db, const string &extension_name) {
	...
	try {
		...
		SABOT_SQL_LOG_INFO(db, "Loaded extension '%s'", extension_name);
	} catch (std::exception &e) {
		ErrorData error(e);
...
//===--------------------------------------------------------------------===//
void ExtensionHelper::LoadAllExtensions(SabotSQL &db) {
...
ExtensionLoadResult ExtensionHelper::LoadExtension(SabotSQL &db, const std::string &extension) {
	return LoadExtensionInternal(db, extension, false);
}

ExtensionLoadResult ExtensionHelper::LoadExtensionInternal(SabotSQL &db, const std::string &extension,
                                                           bool initial_load) {
#ifdef SABOT_SQL_EXTENSIONS_TEST_WITH_LOADABLE
	// Note: weird comma's are on purpose to do easy string contains on a list of extension names
	if (!initial_load && StringUtil::Contains(SABOT_SQL_EXTENSIONS_TEST_WITH_LOADABLE, "," + extension + ",")) {
		Connection con(db);
		auto result = con.Query((string) "LOAD '" + SABOT_SQL_EXTENSIONS_BUILD_PATH + "/" + extension + "/" + extension +
		                        ".sabot_sql_extension'");
		if (result->HasError()) {
			result->Print();
...
#if SABOT_SQL_EXTENSION_HTTPFS_LINKED
...
#if SABOT_SQL_EXTENSION_EXCEL_LINKED
...
#if SABOT_SQL_EXTENSION_INET_LINKED

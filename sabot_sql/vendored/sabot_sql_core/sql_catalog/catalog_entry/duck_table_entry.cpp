...
#include "sabot_sql/execution/index/art/art.hpp"
#include "sabot_sql/function/table/table_scan.hpp"
#include "sabot_sql/main/database.hpp"
#include "sabot_sql/parser/constraints/list.hpp"
#include "sabot_sql/parser/parsed_data/comment_on_column_info.hpp"
...
#include "sabot_sql/planner/constraints/bound_not_null_constraint.hpp"
#include "sabot_sql/planner/constraints/bound_unique_constraint.hpp"
#include "sabot_sql/planner/expression/bound_reference_expression.hpp"
#include "sabot_sql/planner/expression_binder/alter_binder.hpp"
...
unique_ptr<CatalogEntry> DuckTableEntry::AlterEntry(ClientContext &context, AlterInfo &info) {
	...
	case AlterTableType::SET_PARTITIONED_BY:
		throw NotImplementedException("SET PARTITIONED BY is not supported for SabotSQL tables");
	case AlterTableType::SET_SORTED_BY:
		throw NotImplementedException("SET SORTED BY is not supported for SabotSQL tables");
	default:

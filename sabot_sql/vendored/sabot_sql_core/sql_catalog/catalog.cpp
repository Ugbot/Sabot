...
#include "sabot_sql/catalog/default/default_schemas.hpp"
...
#include "sabot_sql/planner/expression_binder/index_binder.hpp"
...
#include "sabot_sql/storage/database_size.hpp"
...
bool Catalog::HasConflictingAttachOptions(const string &path, const AttachOptions &options) {
	auto const db_type = options.db_type.empty() ? "sabot_sql" : options.db_type;

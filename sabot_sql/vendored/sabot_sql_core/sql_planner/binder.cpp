...
#include "sabot_sql/parser/query_node/list.hpp"
...
#include "sabot_sql/planner/query_node/list.hpp"
#include "sabot_sql/planner/tableref/list.hpp"
...
BoundStatement Binder::BindReturning(vector<unique_ptr<ParsedExpression>> returning_list, TableCatalogEntry &table,
	...
	// see https://github.com/sabot_sql/sabot_sql/issues/8310
	auto &properties = GetStatementProperties();

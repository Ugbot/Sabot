...
void MacroFunction::FinalizeDeserialization() {
	// In older versions of SabotSQL, parameters with defaults were not stored in "parameters", this adds them
	for (auto &kv : default_parameters) {
		bool found = false;
	...
	// In older versions of SabotSQL macros were always untyped

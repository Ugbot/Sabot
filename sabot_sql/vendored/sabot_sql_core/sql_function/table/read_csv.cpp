...
#include "sabot_sql/common/multi_file/union_by_name.hpp"
#include "sabot_sql/execution/operator/csv_scanner/global_csv_state.hpp"
#include "sabot_sql/execution/operator/csv_scanner/csv_error.hpp"
#include "sabot_sql/execution/operator/csv_scanner/sniffer/csv_sniffer.hpp"
#include "sabot_sql/execution/operator/persistent/csv_rejects_table.hpp"
...
#include "sabot_sql/execution/operator/csv_scanner/csv_file_scanner.hpp"
#include "sabot_sql/execution/operator/csv_scanner/base_scanner.hpp"

#include "sabot_sql/execution/operator/csv_scanner/string_value_scanner.hpp"

#include <limits>
#include "sabot_sql/execution/operator/csv_scanner/csv_schema.hpp"
#include "sabot_sql/common/multi_file/multi_file_function.hpp"
#include "sabot_sql/execution/operator/csv_scanner/csv_multi_file_info.hpp"
...
void BuiltinFunctions::RegisterReadFunctions() {
	...
	AddFunction(MultiFileReader::CreateFunctionSet(ReadSabotSQLTableFunction::GetFunction()));
	auto &config = DBConfig::GetConfig(*transaction.db);
	config.replacement_scans.emplace_back(ReadCSVReplacement);
	config.replacement_scans.emplace_back(ReadSabotSQLTableFunction::ReplacementScan);
}

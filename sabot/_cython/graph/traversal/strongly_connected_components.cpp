...
static int __Pyx_modinit_function_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction_3_1_4(__pyx_t_1, "pyarrow_wrap_array", (void (**)(void))&__pyx_f_7pyarrow_3lib_pyarrow_wrap_array, "PyObject *(std::shared_ptr< arrow::Array>  const &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)

...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/Users/bengamble/Sabot/sabot_cypher/include/sabot_cypher/cypher/sabot_cypher_bridge.h",
        ...
        "include_dirs": [
            ...
            "/Users/bengamble/Sabot/sabot_cypher/vendored/sabot_cypher_core/src/include",
        ...
        "library_dirs": [
            "/Users/bengamble/Sabot/sabot_cypher/build",
            "/opt/homebrew/lib/python3.13/site-packages/pyarrow"
        ],
        "name": "sabot_cypher_native",
        "sources": [
            "sabot_cypher.pyx"
        ]
    },
    "module_name": "sabot_cypher_native"
}
END: Cython Metadata */
...
#define __PYX_HAVE__sabot_cypher_native
#define __PYX_HAVE_API__sabot_cypher_native
/* Early includes */
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
...
struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge;
...
struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge {
  PyObject_HEAD
  std::shared_ptr<sabot_cypher::cypher::SabotCypherBridge>  _bridge;
};
...
/* Module declarations from "sabot_cypher_native" */
...
#define __Pyx_MODULE_NAME "sabot_cypher_native"
extern int __pyx_module_is_main_sabot_cypher_native;
int __pyx_module_is_main_sabot_cypher_native = 0;

/* Implementation of "sabot_cypher_native" */
...
static const char __pyx_k_op_desc[] = "op_desc";
...
static const char __pyx_k_A_AQ_HD_Q[] = "\200A\360\030\000\t\030\320\027,\250A\250Q\330\010\024\320\024)\250\021\250!\360\006\000\t\r\210H\220D\230\002\230.\250\001\250\034\260Q";
...
static const char __pyx_k_edges_table[] = "edges_table";
static const char __pyx_k_has_filters[] = "has_filters";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_execute_plan[] = "execute_plan";
static const char __pyx_k_is_coroutine[] = "_is_coroutine";
static const char __pyx_k_kuzu_version[] = "__kuzu_version__";
static const char __pyx_k_stringsource[] = "<stringsource>";
static const char __pyx_k_create_bridge[] = "create_bridge";
...
static const char __pyx_k_vertices_table[] = "vertices_table";
static const char __pyx_k_setstate_cython[] = "__setstate_cython__";
static const char __pyx_k_sabot_cypher_pyx[] = "sabot_cypher.pyx";
static const char __pyx_k_SabotCypherBridge[] = "SabotCypherBridge";
static const char __pyx_k_execution_time_ms[] = "execution_time_ms";
static const char __pyx_k_asyncio_coroutines[] = "asyncio.coroutines";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_sabot_cypher_native[] = "sabot_cypher_native";
static const char __pyx_k_0_11_2_vendored_frontend_only[] = "0.11.2 (vendored frontend only)";
static const char __pyx_k_SabotCypherBridge_execute_plan[] = "SabotCypherBridge.execute_plan";
static const char __pyx_k_SabotCypher_Cypher_Query_Engine[] = "\nSabotCypher - Cypher Query Engine with Arrow Execution\n\nCython wrapper for sabot_cypher C++ library.\nProvides zero-copy integration with PyArrow.\n";
static const char __pyx_k_A_s_iq_xr_9Cq_WBay_a_was_c_gQa_J[] = "\200A\360\034\000\t\014\210<\220s\230!\330\014\020\220\006\220i\230q\240\001\330\020\027\220x\230r\240\021\240'\250\027\260\001\260\021\340\020\023\2209\230C\230q\330\024\030\230\005\230W\240B\240a\240y\260\006\260a\330\030\037\230w\240a\240s\250'\260\021\260,\270c\300\021\300$\300g\310Q\310a\340\020\024\220J\230j\250\001\250\021\330\020\027\220w\230f\240A\360\006\000\t\r\210M\230\031\240$\240a\240}\260A\330\010\014\320\014\036\230i\240t\2501\320,>\270a\330\010\014\210O\2309\240D\250\001\250\037\270\001\360\006\000\t%\240D\250\010\260\004\260B\260l\300!\3001\360\006\000\t\n\330\014\027\320\027*\250!\2506\260\021\330\014\025\220V\2306\240\027\250\001\250\021\330\014!\240\026\240q\330\014\030\230\006\230a";
static const char __pyx_k_Failed_to_create_SabotCypherBrid[] = "Failed to create SabotCypherBridge";
static const char __pyx_k_Note_that_Cython_is_deliberately[] = "Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.";
static const char __pyx_k_SabotCypherBridge___reduce_cytho[] = "SabotCypherBridge.__reduce_cython__";
static const char __pyx_k_SabotCypherBridge___setstate_cyt[] = "SabotCypherBridge.__setstate_cython__";
static const char __pyx_k_SabotCypherBridge_register_graph[] = "SabotCypherBridge.register_graph";
static const char __pyx_k_no_default___reduce___due_to_non[] = "no default __reduce__ due to non-trivial __cinit__";
/* #### Code section: decls ### */
static int __pyx_pf_19sabot_cypher_native_17SabotCypherBridge___cinit__(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_2register_graph(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self, PyObject *__pyx_v_vertices_table, PyObject *__pyx_v_edges_table); /* proto */
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_4execute_plan(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self, PyObject *__pyx_v_plan_dict); /* proto */
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
static PyObject *__pyx_pf_19sabot_cypher_native_create_bridge(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_tp_new_19sabot_cypher_native_SabotCypherBridge(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
typedef struct {
  ...
  PyObject *__pyx_type_19sabot_cypher_native_SabotCypherBridge;
  PyTypeObject *__pyx_ptype_19sabot_cypher_native_SabotCypherBridge;
...
#define __pyx_kp_u_0_11_2_vendored_frontend_only __pyx_string_tab[1]
#define __pyx_kp_u_0_1_0 __pyx_string_tab[2]
#define __pyx_kp_u_Failed_to_create_SabotCypherBrid __pyx_string_tab[3]
#define __pyx_kp_u_Note_that_Cython_is_deliberately __pyx_string_tab[4]
#define __pyx_n_u_RuntimeError __pyx_string_tab[5]
#define __pyx_n_u_SabotCypherBridge __pyx_string_tab[6]
#define __pyx_n_u_SabotCypherBridge___reduce_cytho __pyx_string_tab[7]
#define __pyx_n_u_SabotCypherBridge___setstate_cyt __pyx_string_tab[8]
#define __pyx_n_u_SabotCypherBridge_execute_plan __pyx_string_tab[9]
#define __pyx_n_u_SabotCypherBridge_register_graph __pyx_string_tab[10]
...
#define __pyx_n_u_c_edges __pyx_string_tab[14]
#define __pyx_n_u_c_vertices __pyx_string_tab[15]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[16]
#define __pyx_n_u_create_bridge __pyx_string_tab[17]
#define __pyx_kp_u_disable __pyx_string_tab[18]
#define __pyx_n_u_edges_table __pyx_string_tab[19]
#define __pyx_kp_u_enable __pyx_string_tab[20]
#define __pyx_n_u_encode __pyx_string_tab[21]
#define __pyx_n_u_execute_plan __pyx_string_tab[22]
#define __pyx_n_u_execution_time_ms __pyx_string_tab[23]
...
#define __pyx_n_u_has_aggregates __pyx_string_tab[28]
#define __pyx_n_u_has_filters __pyx_string_tab[29]
#define __pyx_n_u_has_joins __pyx_string_tab[30]
...
#define __pyx_n_u_kuzu_version __pyx_string_tab[35]
...
#define __pyx_n_u_num_rows __pyx_string_tab[40]
#define __pyx_n_u_op __pyx_string_tab[41]
#define __pyx_n_u_op_desc __pyx_string_tab[42]
#define __pyx_n_u_operators __pyx_string_tab[43]
#define __pyx_n_u_params __pyx_string_tab[44]
#define __pyx_n_u_plan __pyx_string_tab[45]
#define __pyx_n_u_plan_dict __pyx_string_tab[46]
...
#define __pyx_n_u_query __pyx_string_tab[51]
...
#define __pyx_n_u_register_graph __pyx_string_tab[55]
#define __pyx_n_u_result __pyx_string_tab[56]
#define __pyx_n_u_sabot_cypher_native __pyx_string_tab[57]
#define __pyx_kp_u_sabot_cypher_pyx __pyx_string_tab[58]
...
#define __pyx_n_u_val __pyx_string_tab[68]
#define __pyx_n_u_version __pyx_string_tab[69]
#define __pyx_n_u_vertices_table __pyx_string_tab[70]
...
static CYTHON_SMALL_CODE int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge);
  Py_CLEAR(clear_module_state->__pyx_type_19sabot_cypher_native_SabotCypherBridge);
...
static CYTHON_SMALL_CODE int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge);
  Py_VISIT(traverse_module_state->__pyx_type_19sabot_cypher_native_SabotCypherBridge);
...
/* Python wrapper */
static int __pyx_pw_19sabot_cypher_native_17SabotCypherBridge_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_19sabot_cypher_native_17SabotCypherBridge_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_19sabot_cypher_native_17SabotCypherBridge___cinit__(((struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *)__pyx_v_self));
...
static int __pyx_pf_19sabot_cypher_native_17SabotCypherBridge___cinit__(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
...
*/
  __pyx_v_self->_bridge = sabot_cypher::cypher::SabotCypherBridge::Create();
 ...
 * 
*/
  __pyx_t_1 = ((!__pyx_v_self->_bridge) != 0);
...
*/
    ...
    __pyx_t_5 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_Failed_to_create_SabotCypherBrid};
...
*/
  ...
  __Pyx_AddTraceback("sabot_cypher_native.SabotCypherBridge.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_3register_graph(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_19sabot_cypher_native_17SabotCypherBridge_2register_graph, "\n        Register graph data for querying.\n        \n        Args:\n            vertices_table: PyArrow table with vertices\n            edges_table: PyArrow table with edges\n        ");
static PyMethodDef __pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_3register_graph = {"register_graph", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_3register_graph, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_19sabot_cypher_native_17SabotCypherBridge_2register_graph};
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_3register_graph(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_v_vertices_table = 0;
  PyObject *__pyx_v_edges_table = 0;
  #if !CYTHON_METH_FASTCALL
  CYTHON_UNUSED Py_ssize_t __pyx_nargs;
  #endif
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_vertices_table,&__pyx_mstate_global->__pyx_n_u_edges_table,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "register_graph", 0) < 0) __PYX_ERR(0, 77, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("register_graph", 1, 2, 2, i); __PYX_ERR(0, 77, __pyx_L3_error) }
      }
    ...
    __pyx_v_vertices_table = values[0];
    __pyx_v_edges_table = values[1];
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("register_graph", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 77, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("sabot_cypher_native.SabotCypherBridge.register_graph", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_19sabot_cypher_native_17SabotCypherBridge_2register_graph(((struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *)__pyx_v_self), __pyx_v_vertices_table, __pyx_v_edges_table);
...
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_2register_graph(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self, PyObject *__pyx_v_vertices_table, PyObject *__pyx_v_edges_table) {
  std::shared_ptr< arrow::Table>  __pyx_v_c_vertices;
 ...
 * 
*/
  __pyx_t_1 = __pyx_f_7pyarrow_3lib_pyarrow_unwrap_table(__pyx_v_vertices_table); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 89, __pyx_L1_error)
  __pyx_v_c_vertices = __PYX_STD_MOVE_IF_SUPPORTED(__pyx_t_1);
...
*/
  __pyx_t_1 = __pyx_f_7pyarrow_3lib_pyarrow_unwrap_table(__pyx_v_edges_table); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 90, __pyx_L1_error)
...
*/
  __pyx_v_self->_bridge.get()->RegisterGraph(__pyx_v_c_vertices, __pyx_v_c_edges);
...
/* Python wrapper */
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_5execute_plan(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_19sabot_cypher_native_17SabotCypherBridge_4execute_plan, "\n        Execute an ArrowPlan.\n        \n        Args:\n            plan_dict: Dictionary with 'operators' list\n        \n        Returns:\n            dict with 'table', 'query', 'execution_time_ms', 'num_rows'\n        ");
static PyMethodDef __pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_5execute_plan = {"execute_plan", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_5execute_plan, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_19sabot_cypher_native_17SabotCypherBridge_4execute_plan};
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_5execute_plan(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "execute_plan", 0) < 0) __PYX_ERR(0, 95, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("execute_plan", 1, 1, 1, i); __PYX_ERR(0, 95, __pyx_L3_error) }
      }
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("execute_plan", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 95, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("sabot_cypher_native.SabotCypherBridge.execute_plan", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_plan_dict), (&PyDict_Type), 1, "plan_dict", 1))) __PYX_ERR(0, 95, __pyx_L1_error)
  __pyx_r = __pyx_pf_19sabot_cypher_native_17SabotCypherBridge_4execute_plan(((struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *)__pyx_v_self), __pyx_v_plan_dict);
...
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_4execute_plan(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self, PyObject *__pyx_v_plan_dict) {
  sabot_cypher::cypher::ArrowPlan __pyx_v_plan;
  sabot_cypher::cypher::ArrowOperatorDesc __pyx_v_op_desc;
  PyObject *__pyx_v_op = NULL;
  PyObject *__pyx_v_key = NULL;
  PyObject *__pyx_v_val = NULL;
  sabot_cypher::cypher::CypherResult __pyx_v_result;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
...
*/
  ...
  __pyx_t_1 = (__Pyx_PyDict_ContainsTF(__pyx_mstate_global->__pyx_n_u_operators, __pyx_v_plan_dict, Py_EQ)); if (unlikely((__pyx_t_1 < 0))) __PYX_ERR(0, 109, __pyx_L1_error)
  if (__pyx_t_1) {

    /* "sabot_cypher.pyx":110
 *         # Build ArrowPlan from Python dict
 *         if 'operators' in plan_dict:
 *             for op in plan_dict['operators']:             # <<<<<<<<<<<<<<
 *                 op_desc.type = op['type'].encode('utf-8')
...
*/
    ...
    __pyx_t_2 = __Pyx_PyDict_GetItem(__pyx_v_plan_dict, __pyx_mstate_global->__pyx_n_u_operators); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 110, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (likely(PyList_CheckExact(__pyx_t_2)) || PyTuple_CheckExact(__pyx_t_2)) {
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = (CYTHON_COMPILING_IN_LIMITED_API) ? PyIter_Next : __Pyx_PyObject_GetIterNextFunc(__pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 110, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    for (;;) {
      if (likely(!__pyx_t_5)) {
 ...
 *                 if 'params' in op:
*/
      __pyx_t_7 = __Pyx_PyObject_Dict_GetItem(__pyx_v_op, __pyx_mstate_global->__pyx_n_u_type); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 111, __pyx_L1_error)
      ...
      __pyx_t_8 = 0;
      {
        ...
        __pyx_t_2 = __Pyx_PyObject_FastCallMethod(__pyx_mstate_global->__pyx_n_u_encode, __pyx_callargs+__pyx_t_8, (2-__pyx_t_8) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
      ...
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_v_op_desc.type = __PYX_STD_MOVE_IF_SUPPORTED(__pyx_t_9);

      /* "sabot_cypher.pyx":113
 *                 op_desc.type = op['type'].encode('utf-8')
 * 
 *                 if 'params' in op:             # <<<<<<<<<<<<<<
...
*/
      __pyx_t_1 = (__Pyx_PySequence_ContainsTF(__pyx_mstate_global->__pyx_n_u_params, __pyx_v_op, Py_EQ)); if (unlikely((__pyx_t_1 < 0))) __PYX_ERR(0, 113, __pyx_L1_error)
      if (__pyx_t_1) {

        /* "sabot_cypher.pyx":114
 * 
 *                 if 'params' in op:
 *                     for key, val in op['params'].items():             # <<<<<<<<<<<<<<
 *                         op_desc.params[key.encode('utf-8')] = str(val).encode('utf-8')
...
*/
        __pyx_t_10 = 0;
        __pyx_t_7 = __Pyx_PyObject_Dict_GetItem(__pyx_v_op, __pyx_mstate_global->__pyx_n_u_params); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 114, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        if (unlikely(__pyx_t_7 == Py_None)) {
          PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "items");
          __PYX_ERR(0, 114, __pyx_L1_error)
        }
        __pyx_t_6 = __Pyx_dict_iterator(__pyx_t_7, 0, __pyx_mstate_global->__pyx_n_u_items, (&__pyx_t_11), (&__pyx_t_12)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 114, __pyx_L1_error)
        ...
        __pyx_t_6 = 0;
        while (1) {
          __pyx_t_13 = __Pyx_dict_iter_next(__pyx_t_2, __pyx_t_11, &__pyx_t_10, &__pyx_t_6, &__pyx_t_7, NULL, __pyx_t_12);
          if (unlikely(__pyx_t_13 == 0)) break;
          if (unlikely(__pyx_t_13 == -1)) __PYX_ERR(0, 114, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __Pyx_GOTREF(__pyx_t_7);
...
*/
          __pyx_t_7 = __Pyx_PyObject_Unicode(__pyx_v_val); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 115, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_7);
          __pyx_t_6 = PyUnicode_AsUTF8String(((PyObject*)__pyx_t_7)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 115, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
          __pyx_t_9 = __pyx_convert_string_from_py_6libcpp_6string_std__in_string(__pyx_t_6); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 115, __pyx_L1_error)
          ...
          __pyx_t_14 = __pyx_convert_string_from_py_6libcpp_6string_std__in_string(__pyx_t_6); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 115, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          (__pyx_v_op_desc.params[__pyx_t_14]) = __pyx_t_9;
        }
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
      try {
        __pyx_v_plan.operators.push_back(__pyx_v_op_desc);
      } catch(...) {
        __Pyx_CppExn2PyErr();
        __PYX_ERR(0, 117, __pyx_L1_error)
      }

      /* "sabot_cypher.pyx":118
 * 
 *                 plan.operators.push_back(op_desc)
 *                 op_desc.params.clear()  # Reset for next operator             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __pyx_t_3 = __Pyx_PyDict_GetItemDefault(__pyx_v_plan_dict, __pyx_mstate_global->__pyx_n_u_has_joins, Py_False); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_15 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely((__pyx_t_15 == ((bool)-1)) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_plan.has_joins = __pyx_t_15;

  /* "sabot_cypher.pyx":122
 *         # Set flags
 *         plan.has_joins = plan_dict.get('has_joins', False)
 *         plan.has_aggregates = plan_dict.get('has_aggregates', False)             # <<<<<<<<<<<<<<
 *         plan.has_filters = plan_dict.get('has_filters', False)
...
*/
  ...
  __pyx_t_3 = __Pyx_PyDict_GetItemDefault(__pyx_v_plan_dict, __pyx_mstate_global->__pyx_n_u_has_aggregates, Py_False); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_15 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely((__pyx_t_15 == ((bool)-1)) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_plan.has_aggregates = __pyx_t_15;

  /* "sabot_cypher.pyx":123
 *         plan.has_joins = plan_dict.get('has_joins', False)
 *         plan.has_aggregates = plan_dict.get('has_aggregates', False)
 *         plan.has_filters = plan_dict.get('has_filters', False)             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __pyx_t_3 = __Pyx_PyDict_GetItemDefault(__pyx_v_plan_dict, __pyx_mstate_global->__pyx_n_u_has_filters, Py_False); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_15 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely((__pyx_t_15 == ((bool)-1)) && PyErr_Occurred())) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_plan.has_filters = __pyx_t_15;

  /* "sabot_cypher.pyx":126
 * 
 *         # Execute plan
...
*/
  __pyx_v_result = __pyx_v_self->_bridge.get()->ExecutePlan(__pyx_v_plan);

  /* "sabot_cypher.pyx":129
 * 
 *         # Convert result to Python
 *         return {             # <<<<<<<<<<<<<<
...
*/
  __pyx_t_3 = __Pyx_PyDict_NewPresized(4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __pyx_f_7pyarrow_3lib_pyarrow_wrap_table(__pyx_v_result.table); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_table, __pyx_t_2) < 0) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "sabot_cypher.pyx":131
 *         return {
 *             'table': pa.pyarrow_wrap_table(result.table),
 *             'query': result.query.decode('utf-8'),             # <<<<<<<<<<<<<<
 *             'execution_time_ms': result.execution_time_ms,
...
*/
  __pyx_t_2 = __Pyx_decode_cpp_string(__pyx_v_result.query, 0, PY_SSIZE_T_MAX, NULL, NULL, PyUnicode_DecodeUTF8); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 131, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_query, __pyx_t_2) < 0) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "sabot_cypher.pyx":132
 *             'table': pa.pyarrow_wrap_table(result.table),
 *             'query': result.query.decode('utf-8'),
 *             'execution_time_ms': result.execution_time_ms,             # <<<<<<<<<<<<<<
 *             'num_rows': result.num_rows,
 *         }
*/
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_result.execution_time_ms); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 132, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_execution_time_ms, __pyx_t_2) < 0) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "sabot_cypher.pyx":133
 *             'query': result.query.decode('utf-8'),
 *             'execution_time_ms': result.execution_time_ms,
 *             'num_rows': result.num_rows,             # <<<<<<<<<<<<<<
 *         }
 * 
*/
  __pyx_t_2 = __Pyx_PyLong_FromSize_t(__pyx_v_result.num_rows); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 133, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_num_rows, __pyx_t_2) < 0) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_7__reduce_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_7__reduce_cython__ = {"__reduce_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_7__reduce_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_7__reduce_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_r = __pyx_pf_19sabot_cypher_native_17SabotCypherBridge_6__reduce_cython__(((struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *)__pyx_v_self));
...
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_6__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("sabot_cypher_native.SabotCypherBridge.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_9__setstate_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_9__setstate_cython__ = {"__setstate_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_9__setstate_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_9__setstate_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_AddTraceback("sabot_cypher_native.SabotCypherBridge.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_19sabot_cypher_native_17SabotCypherBridge_8__setstate_cython__(((struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *)__pyx_v_self), __pyx_v___pyx_state);
...
static PyObject *__pyx_pf_19sabot_cypher_native_17SabotCypherBridge_8__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
...
/* Python wrapper */
static PyObject *__pyx_pw_19sabot_cypher_native_1create_bridge(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
PyDoc_STRVAR(__pyx_doc_19sabot_cypher_native_create_bridge, "Create a new SabotCypherBridge instance.");
static PyMethodDef __pyx_mdef_19sabot_cypher_native_1create_bridge = {"create_bridge", (PyCFunction)__pyx_pw_19sabot_cypher_native_1create_bridge, METH_NOARGS, __pyx_doc_19sabot_cypher_native_create_bridge};
static PyObject *__pyx_pw_19sabot_cypher_native_1create_bridge(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("create_bridge (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_19sabot_cypher_native_create_bridge(__pyx_self);
...
static PyObject *__pyx_pf_19sabot_cypher_native_create_bridge(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("create_bridge", 0);

  /* "sabot_cypher.pyx":140
 * def create_bridge():
 *     """Create a new SabotCypherBridge instance."""
 *     return SabotCypherBridge()             # <<<<<<<<<<<<<<
 * 
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = NULL;
  __Pyx_INCREF((PyObject *)__pyx_mstate_global->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge);
  __pyx_t_3 = ((PyObject *)__pyx_mstate_global->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge); 
  __pyx_t_4 = 1;
  {
...
*/
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("sabot_cypher_native.create_bridge", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_tp_new_19sabot_cypher_native_SabotCypherBridge(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *p;
  PyObject *o;
  #if CYTHON_COMPILING_IN_LIMITED_API
  ...
  #endif
  p = ((struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *)o);
  __Pyx_default_placement_construct(&(p->_bridge));
  if (unlikely(__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_1__cinit__(o, __pyx_mstate_global->__pyx_empty_tuple, NULL) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_19sabot_cypher_native_SabotCypherBridge(PyObject *o) {
  struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *p = (struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge *)o;
  #if CYTHON_USE_TP_FINALIZE
  if (unlikely((PY_VERSION_HEX >= 0x03080000 || __Pyx_PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE)) && __Pyx_PyObject_GetSlot(o, tp_finalize, destructor)) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
    if (__Pyx_PyObject_GetSlot(o, tp_dealloc, destructor) == __pyx_tp_dealloc_19sabot_cypher_native_SabotCypherBridge) {
      if (PyObject_CallFinalizerFromDealloc(o)) return;
    }
  }
  #endif
  __Pyx_call_destructor(p->_bridge);
  #if CYTHON_USE_TYPE_SLOTS
  (*Py_TYPE(o)->tp_free)(o);
  #else
  {
...
static PyMethodDef __pyx_methods_19sabot_cypher_native_SabotCypherBridge[] = {
  {"register_graph", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_3register_graph, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_19sabot_cypher_native_17SabotCypherBridge_2register_graph},
  {"execute_plan", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_5execute_plan, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_19sabot_cypher_native_17SabotCypherBridge_4execute_plan},
  {"__reduce_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_7__reduce_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0},
  {"__setstate_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_19sabot_cypher_native_17SabotCypherBridge_9__setstate_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
#if CYTHON_USE_TYPE_SPECS
static PyType_Slot __pyx_type_19sabot_cypher_native_SabotCypherBridge_slots[] = {
  {Py_tp_dealloc, (void *)__pyx_tp_dealloc_19sabot_cypher_native_SabotCypherBridge},
  {Py_tp_doc, (void *)PyDoc_STR("\n    SabotCypher bridge for executing Cypher queries with Arrow.\n    \n    Examples:\n        >>> bridge = SabotCypherBridge()\n        >>> bridge.register_graph(vertices_table, edges_table)\n        >>> result = bridge.execute_plan(plan_dict)\n        >>> print(result['table'])\n    ")},
  {Py_tp_methods, (void *)__pyx_methods_19sabot_cypher_native_SabotCypherBridge},
  {Py_tp_new, (void *)__pyx_tp_new_19sabot_cypher_native_SabotCypherBridge},
  {0, 0},
};
static PyType_Spec __pyx_type_19sabot_cypher_native_SabotCypherBridge_spec = {
  "sabot_cypher_native.SabotCypherBridge",
  sizeof(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge),
  0,
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_VERSION_TAG|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE,
  __pyx_type_19sabot_cypher_native_SabotCypherBridge_slots,
};
#else

static PyTypeObject __pyx_type_19sabot_cypher_native_SabotCypherBridge = {
  PyVarObject_HEAD_INIT(0, 0)
  "sabot_cypher_native.""SabotCypherBridge", /*tp_name*/
  sizeof(struct __pyx_obj_19sabot_cypher_native_SabotCypherBridge), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_19sabot_cypher_native_SabotCypherBridge, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_19sabot_cypher_native_SabotCypherBridge, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_19sabot_cypher_native_SabotCypherBridge, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static int __Pyx_modinit_type_init_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Type init code ---*/
  #if CYTHON_USE_TYPE_SPECS
  __pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge = (PyTypeObject *) __Pyx_PyType_FromModuleAndSpec(__pyx_m, &__pyx_type_19sabot_cypher_native_SabotCypherBridge_spec, NULL); if (unlikely(!__pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge)) __PYX_ERR(0, 58, __pyx_L1_error)
  if (__Pyx_fix_up_extension_type_from_spec(&__pyx_type_19sabot_cypher_native_SabotCypherBridge_spec, __pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
  #else
  __pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge = &__pyx_type_19sabot_cypher_native_SabotCypherBridge;
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
  #endif
  #if !CYTHON_USE_TYPE_SPECS
  if (__Pyx_PyType_Ready(__pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge->tp_dictoffset && __pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge->tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge->tp_getattro = PyObject_GenericGetAttr;
  }
  #endif
  if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_SabotCypherBridge, (PyObject *) __pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject *) __pyx_mstate->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_sabot_cypher_native(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_sabot_cypher_native},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "sabot_cypher_native",
      __pyx_k_SabotCypher_Cypher_Query_Engine, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_sabot_cypher_native(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_sabot_cypher_native(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_sabot_cypher_native(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'sabot_cypher_native' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "sabot_cypher_native" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_sabot_cypher_native", 0);
  ...
  if (__pyx_module_is_main_sabot_cypher_native) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sabot_cypher_native")) {
      if (unlikely((PyDict_SetItemString(modules, "sabot_cypher_native", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *         Register graph data for querying.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_3register_graph, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_SabotCypherBridge_register_graph, NULL, __pyx_mstate_global->__pyx_n_u_sabot_cypher_native, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge, __pyx_mstate_global->__pyx_n_u_register_graph, __pyx_t_2) < 0) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *         Execute an ArrowPlan.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_5execute_plan, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_SabotCypherBridge_execute_plan, NULL, __pyx_mstate_global->__pyx_n_u_sabot_cypher_native, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_19sabot_cypher_native_SabotCypherBridge, __pyx_mstate_global->__pyx_n_u_execute_plan, __pyx_t_2) < 0) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * def __setstate_cython__(self, __pyx_state):
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_7__reduce_cython__, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_SabotCypherBridge___reduce_cytho, NULL, __pyx_mstate_global->__pyx_n_u_sabot_cypher_native, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     raise TypeError, "no default __reduce__ due to non-trivial __cinit__"
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_19sabot_cypher_native_17SabotCypherBridge_9__setstate_cython__, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_SabotCypherBridge___setstate_cyt, NULL, __pyx_mstate_global->__pyx_n_u_sabot_cypher_native, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[3])); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     return SabotCypherBridge()
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_19sabot_cypher_native_1create_bridge, 0, __pyx_mstate_global->__pyx_n_u_create_bridge, NULL, __pyx_mstate_global->__pyx_n_u_sabot_cypher_native, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[4])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 138, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_create_bridge, __pyx_t_2) < 0) __PYX_ERR(0, 138, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "sabot_cypher.pyx":144
 * 
 * # Version info
 * __version__ = "0.1.0"             # <<<<<<<<<<<<<<
 ...
 * 
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_version, __pyx_mstate_global->__pyx_kp_u_0_1_0) < 0) __PYX_ERR(0, 144, __pyx_L1_error)

  /* "sabot_cypher.pyx":145
 * # Version info
 * __version__ = "0.1.0"
 * __kuzu_version__ = "0.11.2 (vendored frontend only)"             # <<<<<<<<<<<<<<
 * 
*/
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_kuzu_version, __pyx_mstate_global->__pyx_kp_u_0_11_2_vendored_frontend_only) < 0) __PYX_ERR(0, 145, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init sabot_cypher_native", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init sabot_cypher_native");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_0_11_2_vendored_frontend_only, sizeof(__pyx_k_0_11_2_vendored_frontend_only), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_0_11_2_vendored_frontend_only */
  {__pyx_k_0_1_0, sizeof(__pyx_k_0_1_0), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_0_1_0 */
  {__pyx_k_Failed_to_create_SabotCypherBrid, sizeof(__pyx_k_Failed_to_create_SabotCypherBrid), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_Failed_to_create_SabotCypherBrid */
  ...
  {__pyx_k_SabotCypherBridge, sizeof(__pyx_k_SabotCypherBridge), 0, 1, 1}, /* PyObject cname: __pyx_n_u_SabotCypherBridge */
  {__pyx_k_SabotCypherBridge___reduce_cytho, sizeof(__pyx_k_SabotCypherBridge___reduce_cytho), 0, 1, 1}, /* PyObject cname: __pyx_n_u_SabotCypherBridge___reduce_cytho */
  {__pyx_k_SabotCypherBridge___setstate_cyt, sizeof(__pyx_k_SabotCypherBridge___setstate_cyt), 0, 1, 1}, /* PyObject cname: __pyx_n_u_SabotCypherBridge___setstate_cyt */
  {__pyx_k_SabotCypherBridge_execute_plan, sizeof(__pyx_k_SabotCypherBridge_execute_plan), 0, 1, 1}, /* PyObject cname: __pyx_n_u_SabotCypherBridge_execute_plan */
  {__pyx_k_SabotCypherBridge_register_graph, sizeof(__pyx_k_SabotCypherBridge_register_graph), 0, 1, 1}, /* PyObject cname: __pyx_n_u_SabotCypherBridge_register_graph */
  ...
  {__pyx_k_create_bridge, sizeof(__pyx_k_create_bridge), 0, 1, 1}, /* PyObject cname: __pyx_n_u_create_bridge */
  {__pyx_k_disable, sizeof(__pyx_k_disable), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_disable */
  {__pyx_k_edges_table, sizeof(__pyx_k_edges_table), 0, 1, 1}, /* PyObject cname: __pyx_n_u_edges_table */
  ...
  {__pyx_k_has_filters, sizeof(__pyx_k_has_filters), 0, 1, 1}, /* PyObject cname: __pyx_n_u_has_filters */
  ...
  {__pyx_k_kuzu_version, sizeof(__pyx_k_kuzu_version), 0, 1, 1}, /* PyObject cname: __pyx_n_u_kuzu_version */
  ...
  {__pyx_k_op_desc, sizeof(__pyx_k_op_desc), 0, 1, 1}, /* PyObject cname: __pyx_n_u_op_desc */
  ...
  {__pyx_k_sabot_cypher_native, sizeof(__pyx_k_sabot_cypher_native), 0, 1, 1}, /* PyObject cname: __pyx_n_u_sabot_cypher_native */
  {__pyx_k_sabot_cypher_pyx, sizeof(__pyx_k_sabot_cypher_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_sabot_cypher_pyx */
  ...
  {__pyx_k_vertices_table, sizeof(__pyx_k_vertices_table), 0, 1, 1}, /* PyObject cname: __pyx_n_u_vertices_table */
  {0, 0, 0, 0, 0}
};
/* InitStrings.proto */
...
static int __Pyx_InitCachedBuiltins(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  __pyx_builtin_RuntimeError = __Pyx_GetBuiltinName(__pyx_mstate->__pyx_n_u_RuntimeError); if (!__pyx_builtin_RuntimeError) __PYX_ERR(0, 75, __pyx_L1_error)
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 5, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 77, 43};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_vertices_table, __pyx_mstate->__pyx_n_u_edges_table, __pyx_mstate->__pyx_n_u_c_vertices, __pyx_mstate->__pyx_n_u_c_edges};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_sabot_cypher_pyx, __pyx_mstate->__pyx_n_u_register_graph, __pyx_k_A_AQ_HD_Q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {2, 0, 0, 8, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 95, 226};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_plan_dict, __pyx_mstate->__pyx_n_u_plan, __pyx_mstate->__pyx_n_u_op_desc, __pyx_mstate->__pyx_n_u_op, __pyx_mstate->__pyx_n_u_key, __pyx_mstate->__pyx_n_u_val, __pyx_mstate->__pyx_n_u_result};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_sabot_cypher_pyx, __pyx_mstate->__pyx_n_u_execute_plan, __pyx_k_A_s_iq_xr_9Cq_WBay_a_was_c_gQa_J, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
  {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {0, 0, 0, 0, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 138, 10};
    PyObject* const varnames[] = {0};
    __pyx_mstate_global->__pyx_codeobj_tab[4] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_sabot_cypher_pyx, __pyx_mstate->__pyx_n_u_create_bridge, __pyx_k_A, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[4])) goto bad;
  }
